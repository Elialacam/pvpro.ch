...
export const cities: City[] = [
  ...
  { name: 'Thurgau', slug: 'winterthur', canton: 'TG', language: 'de', sunshineHours: 1566, population: 111851 },
  ...
  { name: 'Schwyz', slug: 'biel', canton: 'SZ', language: 'de', sunshineHours: 1694, population: 55206 },
  { name: 'Valais', slug: 'thun', canton: 'VS', language: 'de', sunshineHours: 1694, population: 43476 },
  { name: 'Uri', slug: 'koeniz', canton: 'UR', language: 'de', sunshineHours: 1694, population: 41705 },
  { name: 'Schaffhausen', slug: 'schaffhausen', canton: 'SH', language: 'de', sunshineHours: 1644, population: 36952 },
  { name: 'Appenzell', slug: 'fribourg', canton: 'AI/AR', language: 'fr', sunshineHours: 1720, population: 38039 },
  { name: 'Graubünden', slug: 'chur', canton: 'GR', language: 'de', sunshineHours: 1803, population: 36336 },
  { name: 'Glarus', slug: 'aarau', canton: 'GL', language: 'de', sunshineHours: 1605, population: 21501 },
  { name: 'Zug', slug: 'zug', canton: 'ZG', language: 'de', sunshineHours: 1598, population: 30542 },
  { name: 'Unterwalden', slug: 'neuchatel', canton: 'OW/NW', language: 'fr', sunshineHours: 1739, population: 33455 },
  { name: 'Solothurn', slug: 'solothurn', canton: 'SO', language: 'de', sunshineHours: 1631, population: 16777 },
  { name: 'Aargau', slug: 'baden', canton: 'AG', language: 'de', sunshineHours: 1605, population: 19755 },
];
