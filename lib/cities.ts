...
export const cities: City[] = [
  ...
  { name: 'Freiburg', slug: 'freiburg', canton: 'FR', language: 'de' },
  { name: 'Biel/Bienne', slug: 'biel', canton: 'BE', language: 'de' },
  { name: 'Wallis', slug: 'wallis', canton: 'VS', language: 'de' },
  // Bilingual cantons — FR versions
  { name: 'Fribourg', slug: 'fribourg', canton: 'FR', language: 'fr' },
  { name: 'Biel/Bienne', slug: 'bienne', canton: 'BE', language: 'fr' },
];
