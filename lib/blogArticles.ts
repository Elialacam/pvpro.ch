...
const articles: BlogArticle[] = [
  ...
  // ─── LOHNT SICH (DE) ─────────────────────────────────────────────────────
  {
    ...
    ctaButton: 'Kostenlose Offerte anfordern',
    formUrl: '/anfrage',
    relatedSlugs: ['solaranlage-steuerabzug-schweiz-2026', 'solaranlage-waermepumpe-kombinieren-schweiz', 'besten-solarinstallateur-schweiz-finden', 'roi-photovoltaik-schweiz', 'foerderungen-photovoltaik-2026'],
    relatedPageLinks: [
