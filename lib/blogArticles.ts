...
const articles: BlogArticle[] = [
  ...
  // ─── FÖRDERUNGEN (DE) ────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: ['Bestehende Gebäude: 100% der förderberechtigten Kosten nach Abzug von Subventionen sind als Liegenschaftsunterhalt vom steuerbaren Einkommen abziehbar; nicht für Neubauten, kantonale Unterschiede vorbehalten'],
      },
      {
  ...
  // ─── FÖRDERUNGEN (FR) ────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: ["Bâtiments existants: 100% des coûts éligibles nets de subventions sont déductibles du revenu imposable comme entretien immobilier; pas pour les constructions neuves, sous réserve des différences cantonales"],
      },
      {
  ...
  // ─── FÖRDERUNGEN (EN) ────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: ['Existing buildings: 100% of eligible costs net of subsidies are deductible from taxable income as property maintenance; not for new builds, subject to cantonal differences'],
      },
      {
  ...
  // ─── FÖRDERUNGEN (IT) ────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: ["Edifici esistenti: il 100% dei costi ammissibili al netto degli incentivi è deducibile dal reddito imponibile come manutenzione immobiliare; non per le nuove costruzioni, salve differenze cantonali"],
      },
      {
  ...
  // ─── STEUERABZUG (DE) ────────────────────────────────────────────────────
  {
    ...
    ctaText: "2026 und 2027 sind die letzten Jahre mit vollem Steuerabzug auf Bundesebene. Holen Sie jetzt kostenlos bis zu 3 Offerten von zertifizierten Installateuren aus Ihrem Kanton ein.",
    ctaButton: 'Kostenlose Offerte anfordern',
    formUrl: '/anfrage',
  ...
  // ─── STEUERABZUG (FR) ────────────────────────────────────────────────────
  {
    ...
    ctaText: "2026 et 2027 sont les dernières années avec pleine déduction fiscale au niveau fédéral. Demandez maintenant gratuitement jusqu'à 3 offres d'installateurs certifiés de votre canton.",
    ctaButton: 'Demander une offre gratuite',
    formUrl: '/fr/demande',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
  ...
  // ─── STEUERABZUG (EN) ────────────────────────────────────────────────────
  {
    ...
    ctaText: "2026 and 2027 are the last years with full tax deduction at the federal level. Request up to 3 free quotes from certified installers in your canton now.",
    ctaButton: 'Request a free quote',
    formUrl: '/en/request',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
  ...
  // ─── STEUERABZUG (IT) ────────────────────────────────────────────────────
  {
    ...
    ctaText: "Il 2026 e il 2027 sono gli ultimi anni con piena deduzione fiscale a livello federale. Richiedi ora gratuitamente fino a 3 preventivi da installatori certificati del tuo Cantone.",
    ctaButton: 'Richiedi preventivo gratuito',
    formUrl: '/it/richiesta',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
