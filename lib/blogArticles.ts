...
const articles: BlogArticle[] = [
  ...
  // ─── FÖRDERUNGEN (DE) ────────────────────────────────────────────────────────
  {
    ...
    readMin: 7,
    tag: 'Förderungen',
    intro: 'Die Schweiz unterstützt Solaranlagen 2026 auf mehreren Ebenen: mit der Einmalvergütung des Bundes über Pronovo, möglichen lokalen Programmen und steuerlich abziehbaren Kosten. Welche Beiträge tatsächlich gelten, hängt vom Projekt, Standort und Zeitpunkt ab.',
    sections: [
      {
        heading: 'Die Einmalvergütung (EIV): Bundesförderung für berechtigte Anlagen',
        content: ['Die Einmalvergütung (EIV) ist die wichtigste Bundesförderung für neue Solaranlagen und wird einmalig nach erfolgreicher Inbetriebnahme überwiesen – kein laufender Beitrag, keine Rückzahlung.', 'Die konkrete EIV hängt unter anderem von Inbetriebnahmedatum, Leistung, Anlagentyp und anwendbaren Boni ab. Es gibt deshalb keine allgemeingültige Prozentangabe oder pauschale CHF-pro-kWp-Formel. Für die aktuelle Berechnung ist der Pronovo-Rechner massgeblich.'],
        stats: [{ label: 'Auszahlung', value: 'Einmalig' }],
      },
      {
        heading: 'Kantonale Programme und Steuerabzug',
        content: ['Zusätzliche Beiträge von Kanton, Gemeinde oder Energieversorger sind möglich, aber nicht schweizweit einheitlich und nicht automatisch kumulierbar. Prüfen Sie jedes Programm bei der zuständigen Stelle.', 'Ein Steuerabzug ist kein Zuschuss: Er reduziert das steuerbare Einkommen und hängt von den steuerlich anerkannten Kosten, dem Standort und dem persönlichen Steuersatz ab.'],
        bullets: ['Bestehende Gebäude: Bis zu 100% der förderberechtigten Kosten nach Abzug von Subventionen können – sofern steuerlich anerkannt – als Liegenschaftsunterhalt vom steuerbaren Einkommen abziehbar sein; nicht für Neubauten, kantonale Unterschiede vorbehalten'],
      },
      {
        heading: 'Schritt-für-Schritt: So beantragen Sie Ihre Förderung',
        content: ['Ihr Installateur kann Sie bei den Anmeldungen unterstützen. Trotzdem ist es wichtig, den Prozess zu verstehen, damit Voraussetzungen, Fristen und Zuständigkeiten nicht übersehen werden.'],
        ...
        highlight: 'PvPro.ch-Partnerinstallateure können Sie bei den Anmeldungen unterstützen; die zuständigen Stellen prüfen die Voraussetzungen und entscheiden über Beiträge.',
      },
      {
        heading: 'Neue Förderungen 2026: Was ist neu?',
        content: ['Das Jahr 2026 bringt Änderungen bei einzelnen Bundes- und lokalen Programmen. Förderbedingungen und Bauvorschriften müssen deshalb nach Standort und Gebäudeart geprüft werden; eine Solarpflicht ist keine pauschale Förderzusage.'],
        bullets: ['EIV: Betrag und Berechtigung über den aktuellen Pronovo-Rechner prüfen', 'Aargau: Für normale PV ist vor allem die EIV über Pronovo relevant; kantonale Beratung und lokale Programme sind separat zu prüfen', 'Basel-Stadt: PV grundsätzlich über die Bundesförderung; Basel-Landschaft ist bei PV-bezogenen Boni vom konkreten Sanierungsfall abhängig', 'Bern: KLEIV/GREIV des Bundes und kantonale Solarvorschriften getrennt betrachten', 'Appenzell Ausserrhoden und Appenzell Innerrhoden nicht als ein gemeinsames Förderprogramm behandeln'],
      },
    ],
    ctaHeading: 'Förderung sichern – jetzt Offerte anfordern',
    ctaText: 'Unsere Partnerinstallateure unterstützen Sie bei der Förderabwicklung und prüfen die für Ihr Projekt relevanten Programme. Kostenlos und unverbindlich; die konkrete EIV und Förderberechtigung werden von den zuständigen Stellen bestimmt.',
    ctaButton: 'Jetzt kostenlose Offerte anfordern',
    formUrl: '/anfrage',
    ...
    faqs: [
      { question: 'Wie wird die EIV berechnet?', answer: 'Die EIV hängt unter anderem von Inbetriebnahmedatum, Leistung, Anlagentyp und möglichen Boni ab. Prüfen Sie den aktuellen Betrag mit dem Pronovo-Rechner; eine feste Prozent- oder CHF-pro-kWp-Angabe ist nicht universell gültig.' },
      { question: 'Kann ich EIV und kantonale Förderung gleichzeitig beantragen?', answer: 'Das hängt von den jeweiligen Programmbedingungen ab. EIV und ein kantonales, kommunales oder Versorgerprogramm müssen separat geprüft werden; eine automatische Kumulierung darf nicht vorausgesetzt werden.' },
      ...
      { question: 'Gilt der Steuerabzug in allen Schweizer Kantonen?', answer: 'Für bestehende Gebäude können in allen Kantonen steuerlich anerkannte, förderberechtigte Kosten grundsätzlich als Liegenschaftsunterhalt vom steuerbaren Einkommen abgezogen werden; bis zu 100% der anerkannten Kosten sind möglich. Das ist kein direkter Zuschuss und der tatsächliche Steuervorteil variiert nach kantonalem Recht und persönlichem Steuersatz.' },
    ],
  },
  ...
  // ─── FÖRDERUNGEN (FR) ────────────────────────────────────────────────────────
  {
    ...
    readMin: 7,
    tag: 'Subventions',
    intro: "En 2026, la Suisse soutient les installations solaires à plusieurs niveaux: rétribution unique de la Confédération via Pronovo, programmes locaux éventuels et coûts déductibles fiscalement. Les aides réellement applicables dépendent du projet, du lieu et de la date.",
    sections: [
      {
        heading: 'La rétribution unique (RU): aide fédérale pour les installations éligibles',
        content: ["La rétribution unique (RU) est la principale aide fédérale pour les nouvelles installations solaires. Elle est versée en une seule fois après la mise en service – pas de contribution continue, pas de remboursement.", "Le montant concret dépend notamment de la date de mise en service, de la puissance, du type d'installation et des bonus applicables. Il n'existe donc ni pourcentage universel ni formule forfaitaire en CHF par kWc. Pour le calcul actuel, utilisez le calculateur Pronovo."],
        stats: [{ label: 'Versement', value: 'Unique' }],
      },
      {
        heading: "Programmes cantonaux et déduction fiscale",
        content: ["Des contributions du canton, de la commune ou du fournisseur d'énergie peuvent exister, mais elles ne sont ni uniformes en Suisse ni automatiquement cumulables. Vérifiez chaque programme auprès de l'autorité compétente.", "Une déduction fiscale n'est pas une subvention: elle réduit le revenu imposable et dépend des coûts reconnus, du lieu et du taux d'imposition personnel."],
        bullets: ["Bâtiments existants: jusqu'à 100% des coûts éligibles nets de subventions peuvent, s'ils sont reconnus fiscalement, être déduits du revenu imposable comme entretien immobilier; pas pour les constructions neuves, sous réserve des différences cantonales"],
      },
      {
        heading: 'Étape par étape: comment obtenir vos subventions',
        content: ["Votre installateur peut vous aider dans les démarches. Il est néanmoins important de comprendre le processus, les conditions, les délais et les autorités compétentes."],
        ...
        highlight: "Les installateurs partenaires de PvPro.ch peuvent vous aider dans les démarches; les autorités compétentes vérifient les conditions et décident des aides.",
      },
      {
        heading: 'Nouvelles aides 2026: quoi de neuf?',
        content: ["L'année 2026 apporte des changements dans certains programmes fédéraux et locaux. Les conditions de subvention et les règles de construction doivent donc être vérifiées selon le lieu et le type de bâtiment; une obligation solaire ne constitue pas une promesse générale de subvention."],
        bullets: ["RU: vérifier le montant et l'éligibilité avec le calculateur Pronovo actuel", "Argovie: pour une PV ordinaire, la RU via Pronovo est la référence; les conseils cantonaux et programmes locaux se vérifient séparément", "Bâle-Ville: la PV relève en principe de la Confédération; en Bâle-Campagne, les bonus liés à la PV dépendent du cas de rénovation", "Berne: distinguer les instruments fédéraux KLEIV/GREIV des règles cantonales sur le solaire", "Appenzell Rhodes-Extérieures et Appenzell Rhodes-Intérieures ne constituent pas un programme de subvention commun"],
      },
    ],
    ctaHeading: "Obtenez vos subventions – demandez une offre maintenant",
    ctaText: "Nos installateurs partenaires vous aident dans les démarches et vérifient les programmes pertinents pour votre projet. Gratuit et sans engagement; le montant concret de la RU et l'éligibilité sont déterminés par les autorités compétentes.",
    ctaButton: 'Demander une offre gratuite',
    formUrl: '/fr/demande',
    relatedSlugs: ['roi-photovoltaik-schweiz', 'batteriespeicher-solaranlage-lohnt-sich', 'richtigen-solarinstallateur-schweiz-waehlen'],
    faqs: [
      { question: "Comment la RU est-elle calculée?", answer: "La RU dépend notamment de la date de mise en service, de la puissance, du type d'installation et des éventuels bonus. Vérifiez le montant actuel avec le calculateur Pronovo; aucun pourcentage ou montant forfaitaire par kWc n'est universel." },
      { question: "Puis-je demander la RU et les aides cantonales simultanément?", answer: "Cela dépend des conditions de chaque programme. La RU et une aide cantonale, communale ou d'un fournisseur doivent être vérifiées séparément; leur cumul ne doit pas être présumé automatiquement." },
      { question: "Quand la RU est-elle versée?", answer: "La RU est versée après la mise en service réussie et le contrôle par Pronovo." },
      { question: "La déduction fiscale s'applique-t-elle dans tous les cantons suisses?", answer: "Pour les bâtiments existants, les coûts éligibles reconnus fiscalement peuvent en principe être déduits comme entretien immobilier dans tous les cantons; jusqu'à 100% des coûts reconnus est possible. Ce n'est pas une subvention directe et l'avantage réel varie selon le droit cantonal et le taux d'imposition personnel." },
    ],
  },
  ...
  // ─── FÖRDERUNGEN (EN) ────────────────────────────────────────────────────────
  {
    ...
    readMin: 7,
    tag: 'Subsidies',
    intro: 'In 2026, Switzerland supports solar installations at several levels: the federal one-time payment through Pronovo, possible local programmes and tax-deductible costs. The support that actually applies depends on the project, location and date.',
    sections: [
      {
        heading: 'The one-time payment (EIV): federal subsidy for eligible systems',
        content: ['The one-time payment (EIV) is the main federal subsidy for new solar installations. It is paid once after successful commissioning – no ongoing contribution, no repayment.', 'The actual amount depends, among other things, on commissioning date, capacity, system type and applicable bonuses. There is therefore no universal percentage or flat CHF-per-kWp formula. Use the current Pronovo calculator for the current calculation.'],
        stats: [{ label: 'Payment', value: 'One-time' }],
      },
      {
        heading: 'Cantonal programmes and tax deductions',
        content: ['Additional contributions from a canton, municipality or energy supplier may exist, but they are not uniform across Switzerland and are not automatically cumulative. Check each programme with the responsible authority.', 'A tax deduction is not a subsidy: it reduces taxable income and depends on recognised costs, location and the taxpayer’s marginal rate.'],
        bullets: ['Existing buildings: up to 100% of eligible costs net of subsidies may, where recognised for tax purposes, be deductible from taxable income as property maintenance; not for new builds, subject to cantonal differences'],
      },
      {
        heading: 'Step by step: how to claim your subsidies',
        content: ['Your installer can help with the applications. Still, it is worth understanding the process, conditions, deadlines and responsible authorities.'],
        ...
        highlight: 'PvPro.ch partner installers can help with applications; the responsible authorities check eligibility and decide on the payments.',
      },
      {
        heading: 'New subsidies 2026: what is new?',
        content: ['2026 brings changes to selected federal and local programmes. Subsidy conditions and building rules must therefore be checked by location and building type; a solar obligation is not a general promise of funding.'],
        bullets: ['EIV: check the amount and eligibility with the current Pronovo calculator', 'Aargau: for ordinary PV, the EIV through Pronovo is the reference; cantonal advice and local programmes must be checked separately', 'Basel-Stadt: PV is generally supported federally; in Basel-Landschaft, PV-related bonuses depend on the specific renovation case', 'Bern: distinguish federal KLEIV/GREIV instruments from cantonal solar rules', 'Appenzell Ausserrhoden and Appenzell Innerrhoden are not one shared subsidy programme'],
      },
    ],
    ctaHeading: 'Secure your subsidies – request a quote now',
    ctaText: 'Our partner installers help with the application process and check the programmes relevant to your project. Free and non-binding; the actual EIV and eligibility are determined by the responsible authorities.',
    ctaButton: 'Request a free quote',
    formUrl: '/en/request',
    relatedSlugs: ['roi-photovoltaik-schweiz', 'batteriespeicher-solaranlage-lohnt-sich', 'richtigen-solarinstallateur-schweiz-waehlen'],
    faqs: [
      { question: 'How is the EIV calculated?', answer: 'The EIV depends, among other things, on commissioning date, capacity, system type and applicable bonuses. Check the current amount with the Pronovo calculator; no percentage or flat amount per kWp is universally valid.' },
      { question: 'Can I claim the EIV and cantonal subsidy at the same time?', answer: 'That depends on the conditions of each programme. The EIV and any cantonal, municipal or supplier programme must be checked separately; do not assume that they are automatically cumulative.' },
      { question: 'When is the EIV paid?', answer: 'The EIV is paid after successful commissioning and review by Pronovo.' },
      { question: 'Does the tax deduction apply in all Swiss cantons?', answer: 'For existing buildings, recognised eligible costs can in principle be deducted as property maintenance in all cantons; up to 100% of recognised costs may qualify. This is not a direct subsidy, and the actual tax benefit varies with cantonal rules and the taxpayer’s marginal rate.' },
    ],
  },
  ...
  // ─── FÖRDERUNGEN (IT) ────────────────────────────────────────────────────────
  {
    ...
    readMin: 7,
    tag: 'Incentivi',
    intro: "Nel 2026 la Svizzera sostiene gli impianti solari su più livelli: la remunerazione unica federale tramite Pronovo, eventuali programmi locali e costi fiscalmente deducibili. Gli aiuti effettivamente applicabili dipendono dal progetto, dal luogo e dalla data.",
    sections: [
      {
        heading: 'La Remunerazione Unica (RU): incentivo federale per impianti ammissibili',
        content: ["La Remunerazione Unica (RU) è il principale incentivo federale per i nuovi impianti solari. Viene versata una sola volta dopo la messa in servizio – nessun contributo continuativo, nessun rimborso.", "L'importo concreto dipende tra l'altro dalla data di messa in servizio, dalla potenza, dal tipo di impianto e dai bonus applicabili. Non esiste quindi una percentuale universale né una formula forfettaria in CHF per kWp. Per il calcolo aggiornato va usato il calcolatore Pronovo."],
        stats: [{ label: 'Versamento', value: 'Unico' }],
      },
      {
        heading: 'Programmi cantonali e deduzione fiscale',
        content: ["Contributi aggiuntivi di Cantone, Comune o fornitore di energia possono esistere, ma non sono uniformi in Svizzera e non sono automaticamente cumulabili. Verifica ogni programma presso l'autorità competente.", "Una deduzione fiscale non è un sussidio: riduce il reddito imponibile e dipende dai costi riconosciuti, dal luogo e dall'aliquota marginale personale."],
        bullets: ["Edifici esistenti: fino al 100% dei costi ammissibili al netto degli incentivi può, se riconosciuto fiscalmente, essere deducibile dal reddito imponibile come manutenzione immobiliare; non per le nuove costruzioni, salve differenze cantonali"],
      },
      {
        heading: 'Passo per passo: come ottenere gli incentivi',
        content: ["Il tuo installatore può aiutarti nelle domande. Vale comunque la pena capire il processo, i requisiti, le scadenze e le autorità competenti."],
        ...
        highlight: "Gli installatori partner di PvPro.ch possono aiutarti nelle domande; le autorità competenti verificano i requisiti e decidono gli incentivi.",
      },
      {
        heading: 'Nuovi incentivi 2026: cosa c\'è di nuovo?',
        content: ["Il 2026 porta cambiamenti in singoli programmi federali e locali. Le condizioni degli incentivi e le regole edilizie vanno quindi verificate in base al luogo e al tipo di edificio; un obbligo solare non costituisce una promessa generale di finanziamento."],
        bullets: ["RU: verifica importo e ammissibilità con il calcolatore Pronovo aggiornato", "Argovia: per il normale fotovoltaico il riferimento è la RU tramite Pronovo; consulenze cantonali e programmi locali vanno verificati separatamente", "Basilea Città: il fotovoltaico è sostenuto in linea di principio dalla Confederazione; a Basilea Campagna i bonus legati al PV dipendono dal caso concreto di ristrutturazione", "Berna: distinguere gli strumenti federali KLEIV/GREIV dalle regole cantonali sull'energia solare", "Appenzello Esterno e Appenzello Interno non costituiscono un unico programma di incentivi"],
      },
    ],
    ctaHeading: "Assicurati gli incentivi – richiedi un preventivo ora",
    ctaText: "I nostri installatori partner ti aiutano nella procedura e verificano i programmi rilevanti per il tuo progetto. Gratuito e senza impegno; importo effettivo della RU e ammissibilità sono determinati dalle autorità competenti.",
    ctaButton: 'Richiedi preventivo gratuito',
    formUrl: '/it/richiesta',
    relatedSlugs: ['roi-photovoltaik-schweiz', 'batteriespeicher-solaranlage-lohnt-sich', 'richtigen-solarinstallateur-schweiz-waehlen'],
    faqs: [
      { question: "Come viene calcolata la RU?", answer: "La RU dipende tra l'altro dalla data di messa in servizio, dalla potenza, dal tipo di impianto e dagli eventuali bonus. Verifica l'importo aggiornato con il calcolatore Pronovo; nessuna percentuale o somma forfettaria per kWp è universalmente valida." },
      { question: "Posso richiedere la RU e il contributo cantonale contemporaneamente?", answer: "Dipende dalle condizioni dei singoli programmi. RU e qualsiasi programma cantonale, comunale o del fornitore devono essere verificati separatamente; non si deve presumere il cumulo automatico." },
      ...
      { question: "La deduzione fiscale si applica in tutti i cantoni svizzeri?", answer: "Per gli edifici esistenti, i costi ammissibili riconosciuti fiscalmente possono in linea di principio essere dedotti come manutenzione immobiliare in tutti i cantoni; può essere riconosciuto fino al 100% dei costi riconosciuti. Non è un sussidio diretto e il vantaggio effettivo varia secondo il diritto cantonale e l'aliquota marginale personale." },
    ],
  },
  ...
  // ─── BATTERIESPEICHER (DE) ───────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: ['Die steuerliche Behandlung eines Batteriespeichers ist vom Kanton, Gebäude und Installationszeitpunkt abhängig. Wo die Voraussetzungen erfüllt sind, können anerkannte Kosten als Liegenschaftsunterhalt vom steuerbaren Einkommen abgezogen werden – das ist kein direkter Förderbeitrag.', 'Separate kantonale oder kommunale Speicherprogramme sind möglich, aber nicht allgemein vorauszusetzen. Prüfen Sie das konkrete Programm und die Kumulierbarkeit vor der Bestellung.'],
        bullets: ['Steuerabzug: Voraussetzungen und Umfang beim kantonalen Steueramt prüfen', 'Separate Speicherförderungen nur bei einem aktuell geltenden Programm annehmen', 'Kombination mit Wärmepumpe kann standortabhängig zusätzlich unterstützt werden'],
      },
    ],
    ...
    faqs: [
      ...
      { question: 'Gibt es Förderung für Batteriespeicher in der Schweiz?', answer: 'Das Hinzufügen eines Batteriespeichers erhöht die Einmalvergütung (EIV) des Bundes nicht. Separate kantonale oder kommunale Programme können je nach Standort bestehen und müssen anhand ihrer aktuellen Bedingungen geprüft werden.' },
  ...
  // ─── BATTERIESPEICHER (FR) ───────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: ["Le traitement fiscal d'une batterie dépend du canton, du bâtiment et du moment de l'installation. Lorsque les conditions sont remplies, les coûts reconnus peuvent être déduits du revenu imposable comme entretien immobilier – ce n'est pas une subvention directe.", "Des programmes cantonaux ou communaux distincts pour le stockage peuvent exister, mais ne doivent pas être présumés. Vérifiez le programme concret et son cumul éventuel avant de commander."],
        bullets: ["Déduction fiscale: vérifier les conditions et l'étendue auprès de l'office cantonal des impôts", "Aides séparées au stockage uniquement si un programme actuellement en vigueur le prévoit", "La combinaison avec une pompe à chaleur peut être soutenue en plus selon le lieu"],
      },
    ],
    ...
    faqs: [
      ...
      { question: "Y a-t-il des subventions pour les batteries en Suisse?", answer: "L'ajout d'une batterie n'augmente pas la rétribution unique (RU) fédérale. Des programmes cantonaux ou communaux distincts peuvent exister selon le lieu et doivent être vérifiés dans leurs conditions actuelles." },
  ...
  // ─── BATTERIESPEICHER (EN) ───────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: ['The tax treatment of a battery depends on the canton, building and installation timing. Where the requirements are met, recognised costs may be deducted from taxable income as property maintenance – this is not a direct subsidy.', 'Separate cantonal or municipal storage programmes may exist, but must not be assumed. Check the specific programme and whether it can be combined with other support before ordering.'],
        bullets: ['Tax deduction: check the requirements and scope with the cantonal tax office', 'Assume a separate storage incentive only where a current programme provides for it', 'A heat-pump combination may receive additional support depending on location'],
      },
    ],
    ...
    faqs: [
      ...
      { question: 'Are there subsidies for batteries in Switzerland?', answer: 'Adding a battery does not increase the federal one-time payment (EIV). Separate cantonal or municipal programmes may exist depending on location and must be checked against their current conditions.' },
  ...
  // ─── BATTERIESPEICHER (IT) ───────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: ["Il trattamento fiscale di una batteria dipende dal Cantone, dall'edificio e dal momento dell'installazione. Quando i requisiti sono soddisfatti, i costi riconosciuti possono essere dedotti dal reddito imponibile come manutenzione immobiliare – non è un sussidio diretto.", "Possono esistere programmi cantonali o comunali distinti per l'accumulo, ma non vanno dati per scontati. Verifica il programma concreto e l'eventuale cumulabilità prima dell'ordine."],
        bullets: ["Deduzione fiscale: verifica requisiti ed estensione presso l'ufficio cantonale delle imposte", "Considera un incentivo separato per l'accumulo solo se previsto da un programma attualmente in vigore", "La combinazione con una pompa di calore può ricevere un sostegno aggiuntivo a seconda del luogo"],
      },
    ],
    ...
    faqs: [
      ...
      { question: "Ci sono incentivi per le batterie in Svizzera?", answer: "L'aggiunta di una batteria non aumenta la Remunerazione Unica (RU) federale. Possono esistere programmi cantonali o comunali distinti, da verificare secondo le condizioni attuali del luogo." },
  ...
  // ─── ROI (DE) ────────────────────────────────────────────────────────────────
  {
    ...
    readMin: 8,
    tag: 'Finanzen',
    intro: 'Wie lange, bis sich eine Solaranlage in der Schweiz wirklich rechnet? Diese Frage ist komplexer als sie scheint – denn der ROI variiert je nach Kanton, Systemgrösse und Nutzungsweise erheblich. Die folgenden Bandbreiten sind Orientierungswerte unter Annahmen, keine garantierte Amortisationsdauer.',
    sections: [
      {
        heading: 'Wie berechnet sich der ROI einer Solaranlage?',
        content: ['Eine ROI-Schätzung vergleicht jährliche Einsparungen und Einspeiseerlöse mit den Projektkosten nach den tatsächlich bestätigten Förderungen und allfälligen Steuerfolgen. Die EIV und andere Programme sind nicht pauschal; prüfen Sie die aktuelle EIV mit dem Pronovo-Rechner und lokale Programme separat. Die Amortisationszeit ist deshalb ein Szenario und keine Garantie.'],
        stats: [{ label: 'Orientierungswert Mittelland', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre` }, { label: 'Orientierungswert Tessin und Wallis', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'de')} Jahre` }],
      },
      {
        ...
        bullets: ['Produktion am Standort', `Eigenverbrauch ohne Speicher: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withoutStorage, 'de')}%`, `Eigenverbrauch mit Speicher: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withStorage, 'de')}%`, `Medianstrompreis: ${factNumber(ECONOMIC_FACTS.electricityMedianCtPerKwh)} Rp./kWh`, 'EIV nach aktueller Pronovo-Berechnung und weitere Förderung gemäss den geltenden Programmen'],
      },
      {
        heading: 'ROI-Vergleich nach Kantonen 2026',
        content: [`Die Amortisationszeit hängt vom Standort, der Produktion, dem Eigenverbrauch, dem Strompreis und den bestätigten Projektkosten ab. Die Werte für Mittelland (${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre) sowie Tessin und Wallis (${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'de')} Jahre) dienen nur als Orientierung und sind keine Zusage.`],
        bullets: [`Mittelland: Orientierungswert ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre`, `Tessin und Wallis: Orientierungswert ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'de')} Jahre`],
        highlight: 'Standort, Eigenverbrauch, Kosten und bestätigte Förderung bestimmen die tatsächliche Amortisationszeit.',
      },
      {
    ...
    faqs: [
      { question: 'Wie lange dauert die Amortisation einer Solaranlage in der Schweiz?', answer: `Als Orientierungswerte gelten im Mittelland ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre und im Tessin und Wallis ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'de')} Jahre. Die konkrete Zeit hängt von Systemgrösse, Standort, Nutzung, bestätigten Förderungen und Kosten ab; die Werte sind keine Garantie.` },
  ...
  // ─── ROI (FR) ────────────────────────────────────────────────────────────────
  {
    ...
    readMin: 8,
    tag: 'Finances',
    intro: "Combien de temps avant qu'une installation solaire en Suisse soit vraiment rentable? Cette question est plus complexe qu'elle n'y paraît – car le ROI varie considérablement selon le canton, la taille du système et le mode d'utilisation. Les fourchettes ci-dessous sont des repères fondés sur des hypothèses, pas une durée d'amortissement garantie.",
    sections: [
      {
        heading: "Comment se calcule le ROI d'une installation solaire?",
        content: ["Une estimation du ROI compare les économies annuelles et les revenus d'injection aux coûts du projet après les aides effectivement confirmées et les éventuelles conséquences fiscales. La RU et les autres programmes ne sont pas forfaitaires: vérifiez la RU actuelle avec le calculateur Pronovo et les programmes locaux séparément. La durée d'amortissement est donc un scénario, pas une garantie."],
        stats: [{ label: 'Repère Plateau', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans` }, { label: 'Repère Tessin et Valais', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'fr')} ans` }],
      },
      {
        ...
        bullets: ["Production sur place", `Autoconsommation sans batterie: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withoutStorage, 'fr')}%`, `Autoconsommation avec batterie: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withStorage, 'fr')}%`, `Prix médian de l'électricité: ${factNumber(ECONOMIC_FACTS.electricityMedianCtPerKwh)} ct./kWh`, "RU selon le calcul Pronovo actuel et autres aides selon les programmes applicables"],
      },
      {
        heading: 'Comparaison ROI par canton en 2026',
        content: [`L'amortissement dépend du lieu, de la production, de l'autoconsommation, du prix de l'électricité et des coûts confirmés du projet. Les valeurs du Plateau (${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans) et du Tessin et du Valais (${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'fr')} ans) sont uniquement des repères et ne constituent pas une promesse.`],
        bullets: [`Plateau: repère de ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans`, `Tessin et Valais: repère de ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'fr')} ans`],
        highlight: "Le lieu, l'autoconsommation, les coûts et les aides confirmées déterminent la durée réelle d'amortissement.",
      },
      {
    ...
    relatedSlugs: ['foerderungen-photovoltaik-2026', 'eigenverbrauch-optimieren-solar', 'batteriespeicher-solaranlage-lohnt-sich'],
    faqs: [
      { question: "Quelle est la durée d'amortissement d'une installation solaire en Suisse?", answer: `À titre indicatif, comptez ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans sur le Plateau et ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'fr')} ans au Tessin et en Valais. La durée concrète dépend du système, du lieu, de l'utilisation, des aides confirmées et des coûts; ces valeurs ne sont pas une garantie.` },
  ...
  // ─── ROI (EN) ────────────────────────────────────────────────────────────────
  {
    ...
    readMin: 8,
    tag: 'Finance',
    intro: 'How long until a solar system in Switzerland truly pays off? This question is more complex than it seems – the ROI varies considerably by canton, system size and usage pattern. The ranges below are assumption-based guide values, not a guaranteed payback period.',
    sections: [
      {
        heading: 'How is the ROI of a solar system calculated?',
        content: ['A project ROI estimate compares annual savings and feed-in income with project costs after the subsidies actually confirmed and any tax effects. The EIV and other programmes are not flat amounts: check the current EIV with the Pronovo calculator and verify local programmes separately. Payback is therefore a scenario, not a guarantee.'],
        stats: [{ label: 'Swiss Plateau guide value', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years` }, { label: 'Ticino and Valais guide value', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'en')} years` }],
      },
      {
        ...
        bullets: ['Production at the site', `Self-consumption without storage: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withoutStorage, 'en')}%`, `Self-consumption with storage: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withStorage, 'en')}%`, `Median electricity price: ${factNumber(ECONOMIC_FACTS.electricityMedianCtPerKwh)} ct/kWh`, 'EIV according to the current Pronovo calculation and other support according to applicable programmes'],
      },
      {
        heading: 'ROI comparison by canton in 2026',
        content: [`Payback depends on the site, production, self-consumption, electricity price and confirmed project costs. The Swiss Plateau value (${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years) and the Ticino and Valais value (${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'en')} years) are guide values only and are not a promise.`],
        bullets: [`Swiss Plateau: guide value ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years`, `Ticino and Valais: guide value ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'en')} years`],
        highlight: 'Site, self-consumption, costs and confirmed support determine the actual payback period.',
      },
      {
    ...
    relatedSlugs: ['foerderungen-photovoltaik-2026', 'eigenverbrauch-optimieren-solar', 'batteriespeicher-solaranlage-lohnt-sich'],
    faqs: [
      { question: 'How long does a solar system take to pay off in Switzerland?', answer: `As guide values, payback is ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years on the Swiss Plateau and ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'en')} years in Ticino and Valais. The actual period depends on system size, site, usage, confirmed support and costs; these values are not a guarantee.` },
  ...
  // ─── ROI (IT) ────────────────────────────────────────────────────────────────
  {
    ...
    readMin: 8,
    tag: 'Finanze',
    intro: "Quanto tempo prima che un impianto solare in Svizzera convenga davvero? Questa domanda è più complessa di quanto sembri – il ROI varia notevolmente per cantone, dimensione del sistema e modalità di utilizzo. Gli intervalli seguenti sono valori orientativi basati su ipotesi, non un periodo di ammortamento garantito.",
    sections: [
      {
        heading: "Come si calcola il ROI di un impianto solare?",
        content: ["Una stima del ROI confronta risparmi annuali e ricavi dell'immissione con i costi del progetto dopo gli incentivi effettivamente confermati e gli eventuali effetti fiscali. La RU e gli altri programmi non sono importi forfettari: verifica la RU aggiornata con il calcolatore Pronovo e i programmi locali separatamente. L'ammortamento è quindi uno scenario, non una garanzia."],
        stats: [{ label: 'Valore orientativo Altopiano', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni` }, { label: 'Valore orientativo Ticino e Vallese', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni` }, { label: 'Durata impianto', value: `${factRange(ECONOMIC_FACTS.moduleLifetimeYears, 'it')} anni` }],
      },
      {
        ...
        bullets: ["Produzione sul posto", `Autoconsumo senza accumulo: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withoutStorage, 'it')}%`, `Autoconsumo con accumulo: ${factRange(ECONOMIC_FACTS.selfConsumptionPercent.withStorage, 'it')}%`, `Prezzo mediano dell'energia: ${factNumber(ECONOMIC_FACTS.electricityMedianCtPerKwh)} ct./kWh`, "RU secondo il calcolo Pronovo aggiornato e altri incentivi secondo i programmi applicabili"],
      },
      {
        heading: 'Confronto ROI per cantone nel 2026',
        content: [`L'ammortamento dipende dal luogo, dalla produzione, dall'autoconsumo, dal prezzo dell'energia e dai costi confermati del progetto. I valori per l'Altopiano (${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni) e per Ticino e Vallese (${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni) sono solo orientativi e non costituiscono una promessa.`],
        bullets: [`Altopiano: valore orientativo ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni`, `Ticino e Vallese: valore orientativo ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni`],
        highlight: "Luogo, autoconsumo, costi e incentivi confermati determinano l'ammortamento effettivo.",
      },
      {
    ...
    relatedSlugs: ['foerderungen-photovoltaik-2026', 'eigenverbrauch-optimieren-solar', 'batteriespeicher-solaranlage-lohnt-sich'],
    faqs: [
      { question: "Quanto tempo ci vuole perché un impianto solare si ammortizzi in Svizzera?", answer: `Come valori orientativi, ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni sull'Altopiano e ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni in Ticino e Vallese. Il periodo effettivo dipende da impianto, luogo, utilizzo, incentivi confermati e costi; questi valori non sono una garanzia.` },
  ...
  // ─── LOHNT SICH (DE) ─────────────────────────────────────────────────────
  {
    ...
    readMin: 10,
    tag: 'Ratgeber',
    intro: "Lohnt sich eine Solaranlage in der Schweiz 2026 wirklich? Das kann sie – aber nicht für jeden gleich. Ob sie sich lohnt, hängt von Ihrem Kanton, Ihrem Stromverbrauch, Ihrer Dachausrichtung und den bestätigten Projektkosten und Förderungen ab. Die folgenden Zahlen sind Orientierungswerte und keine garantierte Rendite oder Amortisationsdauer.",
    sections: [
      {
        heading: 'Lohnt sich eine Solaranlage 2026 — die kurze Antwort',
        content: [
          "Lohnt sich eine Solaranlage in der Schweiz 2026? Das kann sich lohnen, muss aber für jedes Projekt geprüft werden. Für die Rechnung sind insbesondere Strompreis, Eigenverbrauch, Kosten und bestätigte Förderungen relevant:",
          "Die Strompreise in der Schweiz haben sich verändert und beeinflussen die Wirtschaftlichkeit.",
          "Die steuerliche Absetzbarkeit läuft Ende 2027 voraussichtlich aus. Ob sich ein Vorziehen lohnt, hängt von den anerkannten Kosten und der persönlichen Steuersituation ab.",
        ],
        stats: [
          { label: 'Orientierungswert Amortisation 2026', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre` },
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
         ...
         highlight: "Fazit: Eine Solaranlage ohne Speicher kann sich lohnen; die Wirtschaftlichkeit hängt vom Projekt ab. Ein Speicher kann bei hohem Abendverbrauch oder mit E-Auto und Wärmepumpe sinnvoll sein. Wer eine Anlage plant, sollte den Wechselrichter so wählen, dass ein Speicher später nachgerüstet werden kann.",
      },
      {
        heading: "Unsere Empfehlung nach 1'000+ vermittelten Anlagen",
        content: [
          "Lohnt sich eine Solaranlage in der Schweiz 2026? Die Wirtschaftlichkeit muss für jedes Projekt geprüft werden. Entscheidend sind nicht pauschale Förderversprechen, sondern bestätigte Förderungen, Kosten, Eigenverbrauch und Stromtarif.",
    ...
    faqs: [
      { question: 'Lohnt sich eine Solaranlage in der Schweiz 2026 wirklich?', answer: "Das kann sie. Gesunkene Modulpreise, Stromtarif, Eigenverbrauch und tatsächlich bestätigte Förderungen beeinflussen die Rechnung; eine allgemeine Zusage für Rendite oder Amortisation ist nicht möglich." },
      { question: 'Lohnt sich eine Solaranlage in der Schweiz auch bei weniger Sonneneinstrahlung?', answer: `Ja, das kann sie. Im Mittelland liegt die typische Produktion bei ${factRange(ECONOMIC_FACTS.production.plateauKwhPerKwp, 'de')} kWh pro kWp und Jahr. ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre sind dort ein Orientierungswert; die tatsächliche Amortisation hängt auch von Kosten, Nutzung und bestätigten Förderungen ab.` },
      { question: 'Wann amortisiert sich eine Solaranlage in der Schweiz?', answer: `Als Orientierungswerte gelten im Mittelland ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'de')} Jahre sowie im Tessin und Wallis ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'de')} Jahre. Die tatsächliche Dauer hängt von Projektkosten, Nutzung und bestätigten Förderungen ab.` },
      { question: 'Lohnt sich eine Solaranlage ohne Batteriespeicher?', answer: "Sie kann sich lohnen. Ob die Rechnung aufgeht, hängt vom Verbrauchsprofil, den Kosten, dem Stromtarif und den bestätigten Förderungen ab." },
  ...
  // ─── LOHNT SICH (FR) ─────────────────────────────────────────────────────
  {
    ...
    readMin: 10,
    tag: 'Guide',
    intro: "Vaut-il vraiment la peine d'investir dans une installation solaire en Suisse en 2026? Cela peut être le cas, mais pas de la même manière pour tout le monde. La rentabilité dépend de votre canton, de votre consommation, de l'orientation de votre toit, des coûts du projet et des aides confirmées. Les chiffres ci-dessous sont des repères, pas un rendement ou un amortissement garanti.",
    sections: [
      {
        heading: "Installation solaire 2026 — la réponse courte",
        content: [
          "Vaut-il la peine d'investir dans une installation solaire en Suisse en 2026? Cela peut être le cas, mais la rentabilité doit être vérifiée pour chaque projet. Le prix de l'électricité, l'autoconsommation, les coûts et les aides confirmées sont notamment déterminants:",
          "Les prix de l'électricité en Suisse ont évolué et influencent la rentabilité.",
          "La déductibilité fiscale expire vraisemblablement fin 2027. L'opportunité d'investir avant cette échéance dépend des coûts reconnus et de votre situation fiscale.",
        ],
        stats: [
          { label: 'Repère d’amortissement 2026', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans` },
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
         ...
         highlight: "Conclusion: Une installation solaire sans batterie peut être rentable, mais la situation doit être calculée. Une batterie peut être intéressante si la consommation en soirée est élevée ou si vous possédez une voiture électrique ou une pompe à chaleur. Lors de la planification, choisissez un onduleur compatible avec l'ajout futur d'une batterie.",
      },
      {
        heading: "Notre recommandation après plus de 1'000 installations",
        content: [
          "Une installation solaire vaut-elle la peine en Suisse en 2026? La rentabilité doit être vérifiée pour chaque projet. Ce ne sont pas des promesses générales de subvention qui déterminent le résultat, mais les aides confirmées, les coûts, l'autoconsommation et le tarif d'électricité.",
    ...
    faqs: [
       { question: "Une installation solaire vaut-elle vraiment la peine en Suisse en 2026?", answer: "Cela peut être le cas. La baisse des prix des modules, le tarif d'électricité, l'autoconsommation et les aides effectivement confirmées influencent le calcul; aucune rentabilité ou durée d'amortissement générale ne peut être garantie." },
       { question: "Une installation solaire vaut-elle la peine en Suisse avec un rayonnement solaire plus faible?", answer: `Oui, cela peut être le cas. Sur le Plateau, la production typique est de ${factRange(ECONOMIC_FACTS.production.plateauKwhPerKwp, 'fr')} kWh par kWc et par an; l'amortissement réel dépend toutefois du projet, des coûts, de l'utilisation et des aides confirmées.` },
       { question: "Quand une installation solaire s'amortit-elle en Suisse?", answer: `À titre indicatif, comptez ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'fr')} ans sur le Plateau et ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'fr')} ans au Tessin et en Valais. La durée exacte dépend du système, du lieu, de l'utilisation, des coûts et des aides confirmées.` },
       { question: "Une installation solaire sans batterie vaut-elle la peine?", answer: "Elle peut être rentable. Le résultat dépend du profil de consommation, des coûts, du tarif d'électricité et des aides confirmées." },
  ...
  // ─── LOHNT SICH (EN) ─────────────────────────────────────────────────────
  {
    ...
    readMin: 10,
    tag: 'Guide',
    intro: "Is solar worth it in Switzerland in 2026? It can be — but not equally for everyone. Whether a system pays off depends on your canton, electricity consumption, roof orientation, confirmed project costs and confirmed support. The figures below are guide values, not a guaranteed return or payback period.",
    sections: [
      {
        heading: 'Is solar worth it in 2026? — the short answer',
        content: [
          "Is solar worth it in Switzerland in 2026? It can be, but the economics must be checked for each project. Electricity prices, self-consumption, costs and confirmed support are particularly important:",
          "Swiss electricity prices have changed and affect the economics.",
          "Tax deductibility is expected to expire at the end of 2027. Whether investing before then is advantageous depends on recognised costs and your personal tax situation.",
        ],
        stats: [
          { label: '2026 payback guide value', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years` },
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
         ...
         highlight: "Conclusion: A solar system without storage can pay off, but the project must be calculated. Storage may make sense when evening consumption is high or you have an electric car and heat pump. When planning, choose an inverter that allows battery storage to be added later.",
      },
      {
        heading: "Our recommendation after 1,000+ installations arranged",
        content: [
          "Is solar worth it in Switzerland in 2026? Economics must be checked for each project. Confirmed support, costs, self-consumption and the electricity tariff matter more than general subsidy promises.",
    ...
    faqs: [
      { question: 'Is solar really worth it in Switzerland in 2026?', answer: 'It can be. Module prices, the electricity tariff, self-consumption and support actually confirmed for the project affect the calculation; no general return or payback period can be guaranteed.' },
       { question: 'Is solar worth it in Switzerland with lower solar irradiation?', answer: `It can be. On the Swiss Plateau, typical production is ${factRange(ECONOMIC_FACTS.production.plateauKwhPerKwp, 'en')} kWh per kWp and year; actual payback still depends on the project, costs, usage and confirmed support.` },
      { question: 'When does a solar system pay back in Switzerland?', answer: `As guide values, payback is ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'en')} years on the Swiss Plateau and ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'en')} years in Ticino and Valais. The actual period depends on project costs, usage and confirmed support.` },
      { question: 'Is solar worth it without battery storage?', answer: 'It can be worthwhile. The result depends on consumption profile, costs, electricity tariff and confirmed support.' },
  ...
  // ─── LOHNT SICH (IT) ─────────────────────────────────────────────────────
  {
    ...
    readMin: 10,
    tag: 'Guida',
    intro: "Vale davvero la pena installare un impianto solare in Svizzera nel 2026? Può convenire, ma non allo stesso modo per tutti. La convenienza dipende dal Cantone, dal consumo elettrico, dall'orientamento del tetto, dai costi del progetto e dagli incentivi confermati. Le cifre seguenti sono valori orientativi, non una redditività o un ammortamento garantiti.",
    sections: [
      {
        heading: 'Vale la pena nel 2026? — la risposta breve',
        content: [
          "Vale la pena installare un impianto solare in Svizzera nel 2026? Può convenire, ma la convenienza va verificata per ogni progetto. Prezzo dell'energia, autoconsumo, costi e incentivi confermati sono particolarmente importanti:",
          "I prezzi dell'energia in Svizzera sono cambiati e influenzano la convenienza.",
          "La detraibilità fiscale scade presumibilmente a fine 2027. L'opportunità di investire prima dipende dai costi riconosciuti e dalla propria situazione fiscale.",
        ],
        stats: [
          { label: 'Valore orientativo ammortamento 2026', value: `${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni` },
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
         ...
         highlight: "Conclusione: Un impianto solare senza accumulo può convenire, ma va calcolato per il progetto. L'accumulo può essere interessante quando il consumo serale è elevato o si dispone di un'auto elettrica e di una pompa di calore. In fase di pianificazione, scegliere un inverter compatibile con l'aggiunta futura di un accumulatore.",
      },
      {
        heading: "La nostra raccomandazione dopo oltre 1'000 impianti realizzati",
        content: [
           "Vale la pena un impianto solare in Svizzera nel 2026? La convenienza va verificata per ogni progetto. A determinare il risultato sono gli incentivi confermati, i costi, l'autoconsumo e la tariffa elettrica, non promesse generiche di finanziamento.",
    ...
    faqs: [
       { question: 'Vale davvero la pena un impianto solare in Svizzera nel 2026?', answer: `Può convenire. Prezzi dei moduli, tariffa elettrica, autoconsumo e incentivi effettivamente confermati influenzano il calcolo; non è possibile garantire una redditività o un periodo di ammortamento generale. Come valori orientativi, sull'Altopiano ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni e in Ticino e Vallese ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni.` },
       { question: 'Vale la pena un impianto solare in Svizzera con meno irraggiamento?', answer: `Può convenire. Sull'Altopiano la produzione tipica è di ${factRange(ECONOMIC_FACTS.production.plateauKwhPerKwp, 'it')} kWh per kWp all'anno; l'ammortamento effettivo dipende comunque da progetto, costi, utilizzo e incentivi confermati.` },
       { question: 'Quando si ammortizza un impianto solare in Svizzera?', answer: `Come valori orientativi, ${factRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'it')} anni sull'Altopiano e ${factRange(ECONOMIC_FACTS.systemPaybackYears.ticinoValais, 'it')} anni in Ticino e Vallese. Il periodo effettivo dipende da costi del progetto, utilizzo e incentivi confermati.` },
       { question: 'Vale la pena un impianto solare senza accumulo?', answer: "Può convenire. Il risultato dipende dal profilo di consumo, dai costi, dalla tariffa elettrica e dagli incentivi confermati." },
  ...
  // ─── STEUERABZUG (DE) ────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        content: [
          "In der Schweiz kann die Installation einer Solaranlage auf einem bestehenden Gebäude als Liegenschaftsunterhalt gelten — also als werterhaltende oder wertvermehrende Massnahme. Steuerlich anerkannte Kosten können dann vom steuerbaren Einkommen abgezogen werden, genau wie eine Dachsanierung oder eine neue Heizung. Das ist eine Steuerentlastung und kein direkter Förderbeitrag.",
        ],
        stats: [
          { label: 'Letzte Chance für Steuerabzug', value: 'Ende 2027' },
        ],
        bullets: [
          "Bis zu 100% der steuerlich anerkannten, förderberechtigten Installationskosten – abhängig von Gebäude, Kanton und Steuerpraxis",
        ...
        highlight: "Nicht abzugsfähig: Anlagen auf Neubauten (in den meisten Kantonen). Fördergelder wie die EIV müssen von der abzugsfähigen Investitionssumme abgezogen werden. 100% anerkannte Kosten bedeuten nicht 100% Steuerersparnis: Der tatsächliche Vorteil hängt vom persönlichen Steuersatz ab.",
      },
      {
        ...
        highlight: "Die Konsequenz: Wer bis Ende 2027 eine Solaranlage installiert, kann auf Bundesebene noch den Abzug der steuerlich anerkannten Kosten beanspruchen. Das ist nicht mit einer direkten Subvention oder einer Steuerersparnis von 100% gleichzusetzen.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Zürich: ✅ Investition absetzbar, ✅ Speicher (gleichzeitig), ✅ Nettoprinzip — kommunale Programme der Stadt Zürich separat prüfen, nicht als kantonale Förderung behandeln",
          "Aargau: ✅ Investition absetzbar, ✅ Speicher (auch Nachrüstung), Bruttoprinzip — keine pauschale kantonale PV- oder Speicherförderung voraussetzen",
          "St. Gallen: ✅ Investition absetzbar, ✅ Speicher (auch Nachrüstung), Nettoprinzip — Energieförderung kantonal",
          "Basel-Stadt: ✅ Investition absetzbar, ✅ Speicher, ✅ Nettoprinzip — PV grundsätzlich über Pronovo; kommunale Programme separat prüfen",
      ...
      },
      {
        ...
        content: [
          ...
          "Fördergelder (EIV): Die Einmalvergütung gilt als Einkommen und muss im Jahr der Auszahlung deklariert werden. Sie ist keine Steuervergünstigung und reduziert zudem die abzugsfähige Investitionssumme.",
        ],
      },
      {
    ...
    ctaText: "2026 und 2027 sind voraussichtlich die letzten Jahre, in denen auf Bundesebene steuerlich anerkannte Kosten geltend gemacht werden können. Holen Sie jetzt kostenlos bis zu 3 Offerten von zertifizierten Installateuren aus Ihrem Kanton ein.",
    ctaButton: 'Kostenlose Offerte anfordern',
    formUrl: '/anfrage',
    ...
    faqs: [
      { question: 'Kann ich eine Solaranlage in der Schweiz von der Steuer abziehen?', answer: "Ja. In fast allen Schweizer Kantonen können steuerlich anerkannte Investitionskosten einer Solaranlage auf einem bestehenden Gebäude als Liegenschaftsunterhalt vom steuerbaren Einkommen abgezogen werden; bis zu 100% der anerkannten Kosten können qualifizieren. Das ist kein direkter Zuschuss und gilt auf Bundesebene voraussichtlich nur noch bis Ende 2027." },
  ...
  // ─── STEUERABZUG (FR) ────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        content: [
          "En Suisse, l'installation solaire sur un bâtiment existant peut être considérée comme de l'entretien immobilier — c'est-à-dire une mesure conservatrice ou amélioratrice de valeur. Les coûts reconnus fiscalement peuvent alors être déduits du revenu imposable, tout comme une rénovation de toiture ou un nouveau chauffage. Il s'agit d'un allègement fiscal, pas d'une subvention directe.",
        ],
        stats: [
          { label: 'Dernière chance pour déduction', value: 'Fin 2027' },
        ],
        bullets: [
          "Jusqu'à 100% des coûts d'installation éligibles reconnus fiscalement – selon le bâtiment, le canton et la pratique fiscale",
        ...
        highlight: "Non déductible: installations sur les nouvelles constructions (dans la plupart des cantons). Les subventions comme la RU doivent être déduites du montant déductible. 100% des coûts reconnus ne signifie pas 100% d'économie d'impôt: l'avantage réel dépend du taux d'imposition personnel.",
      },
      {
        ...
        highlight: "La conséquence: celui qui installe une installation solaire avant fin 2027 peut encore faire valoir les coûts reconnus fiscalement au niveau fédéral. Cela ne constitue ni une subvention directe ni une économie d'impôt de 100%.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Zurich: ✅ Investissement déductible, ✅ Batterie (simultanée), ✅ Principe net — vérifier séparément les programmes de la ville de Zurich, sans les présenter comme une aide cantonale",
          "Argovie: ✅ Investissement déductible, ✅ Batterie (aussi ajout ultérieur), Principe brut — ne pas présumer une aide cantonale générale pour la PV ou le stockage",
          "Saint-Gall: ✅ Investissement déductible, ✅ Batterie (aussi ajout ultérieur), Principe net — Promotion énergétique cantonale",
          "Bâle-Ville: ✅ Investissement déductible, ✅ Batterie, ✅ Principe net — la PV relève en principe de Pronovo; vérifier séparément les programmes communaux",
      ...
      },
      {
        ...
        content: [
          ...
          "Subventions (RU): La rétribution unique est considérée comme un revenu et doit être déclarée dans l'année de versement. Ce n'est pas un avantage fiscal et elle réduit également le montant d'investissement déductible.",
        ],
      },
      {
    ...
    ctaText: "2026 et 2027 sont vraisemblablement les dernières années où les coûts reconnus fiscalement peuvent être déclarés au niveau fédéral. Demandez maintenant gratuitement jusqu'à 3 offres d'installateurs certifiés de votre canton.",
    ctaButton: 'Demander une offre gratuite',
    formUrl: '/fr/demande',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
    ...
    faqs: [
       { question: "Puis-je déduire une installation solaire de mes impôts en Suisse?", answer: "Oui. Dans presque tous les cantons suisses, les coûts d'investissement reconnus fiscalement d'une installation solaire sur un bâtiment existant peuvent être déduits du revenu imposable en tant qu'entretien immobilier; jusqu'à 100% des coûts reconnus peuvent être éligibles. Ce n'est pas une subvention directe et l'avantage fédéral ne devrait être valable que jusqu'à fin 2027." },
  ...
  // ─── STEUERABZUG (EN) ────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        content: [
          "In Switzerland, installing a solar system on an existing building may be classified as property maintenance — a value-preserving or value-enhancing measure. Recognised costs can then be deducted from taxable income, just like a roof renovation or a new heating system. This is tax relief, not a direct subsidy.",
        ],
        stats: [
          { label: 'Last chance for tax deduction', value: 'End of 2027' },
        ],
        bullets: [
          "Up to 100% of tax-recognised eligible installation costs — depending on the building, canton and tax practice",
        ...
        highlight: "Not deductible: systems on new buildings (in most cantons). Subsidies such as the OTP must be deducted from the deductible investment amount. 100% of recognised costs does not mean 100% tax savings: the actual benefit depends on the taxpayer’s marginal rate.",
      },
      {
        ...
        highlight: "The consequence: anyone who installs a solar system before end of 2027 may still claim recognised costs at federal level. This is neither a direct subsidy nor a 100% tax saving.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Zurich: ✅ Investment deductible, ✅ Battery (simultaneous), ✅ Net principle — check City of Zurich programmes separately; do not present them as cantonal support",
          "Aargau: ✅ Investment deductible, ✅ Battery (also retrofit), Gross principle — do not assume a general cantonal PV or storage subsidy",
          "St. Gallen: ✅ Investment deductible, ✅ Battery (also retrofit), Net principle — Cantonal energy promotion",
          "Basel-Stadt: ✅ Investment deductible, ✅ Battery, ✅ Net principle — PV is generally supported through Pronovo; check municipal programmes separately",
      ...
      },
      {
        ...
        content: [
          ...
          "Subsidies (OTP): The one-time payment is considered income and must be declared in the year of payment. It is not a tax deduction and also reduces the deductible investment amount.",
        ],
      },
      {
    ...
    ctaText: "2026 and 2027 are expected to be the last years in which recognised costs can be claimed at federal level. Request up to 3 free quotes from certified installers in your canton now.",
    ctaButton: 'Request a free quote',
    formUrl: '/en/request',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
    ...
    faqs: [
       { question: 'Can I claim a solar system on my taxes in Switzerland?', answer: "Yes. In almost all Swiss cantons, tax-recognised investment costs for a solar system on an existing building can be deducted from taxable income as property maintenance; up to 100% of recognised costs may qualify. This is not a direct subsidy and the federal benefit is expected to apply only until end of 2027." },
  ...
  // ─── STEUERABZUG (IT) ────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        content: [
          "In Svizzera, l'installazione di un impianto solare su un edificio esistente può essere classificata come manutenzione immobiliare — ovvero una misura che conserva o aumenta il valore. I costi riconosciuti fiscalmente possono quindi essere detratti dal reddito imponibile, come un risanamento del tetto o un nuovo sistema di riscaldamento. Si tratta di un'agevolazione fiscale, non di un sussidio diretto.",
        ],
        stats: [
          { label: 'Ultima chance deduzione fiscale', value: 'Fine 2027' },
        ],
        bullets: [
          "Fino al 100% dei costi di installazione ammissibili riconosciuti fiscalmente – in base a edificio, Cantone e prassi fiscale",
        ...
        highlight: "Non detraibile: impianti su nuove costruzioni (nella maggior parte dei cantoni). Gli incentivi come la RU devono essere sottratti dall'importo detraibile dell'investimento. Il 100% dei costi riconosciuti non significa un risparmio fiscale del 100%: il vantaggio effettivo dipende dall'aliquota marginale personale.",
      },
      {
        ...
        highlight: "La conseguenza: chi installa un impianto solare entro fine 2027 può ancora dichiarare i costi riconosciuti a livello federale. Non equivale a un sussidio diretto né a un risparmio fiscale del 100%.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Zurigo: ✅ Investimento detraibile, ✅ Batteria (simultanea), ✅ Principio netto — verificare separatamente i programmi della Città di Zurigo, senza presentarli come incentivi cantonali",
          "Argovia: ✅ Investimento detraibile, ✅ Batteria (anche integrazione), Principio lordo — non presumere un incentivo cantonale generale per PV o accumulo",
          "San Gallo: ✅ Investimento detraibile, ✅ Batteria (anche integrazione), Principio netto — Incentivi energetici cantonali",
          "Basilea-Città: ✅ Investimento detraibile, ✅ Batteria, ✅ Principio netto — il PV è in linea di principio sostenuto tramite Pronovo; verificare separatamente i programmi comunali",
      ...
      },
      {
        ...
        content: [
          ...
          "Incentivi (RU): La remunerazione unica è considerata reddito e deve essere dichiarata nell'anno del versamento. Non è una deduzione fiscale e riduce inoltre l'importo di investimento detraibile.",
        ],
      },
      {
    ...
    ctaText: "Il 2026 e il 2027 sono presumibilmente gli ultimi anni in cui è possibile dichiarare i costi riconosciuti a livello federale. Richiedi ora gratuitamente fino a 3 preventivi da installatori certificati del tuo Cantone.",
    ctaButton: 'Richiedi preventivo gratuito',
    formUrl: '/it/richiesta',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'foerderungen-photovoltaik-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
    ...
    faqs: [
       { question: "Posso detrarre un impianto solare dalle tasse in Svizzera?", answer: "Sì. In quasi tutti i cantoni svizzeri i costi di investimento riconosciuti fiscalmente per un impianto solare su un edificio esistente possono essere detratti dal reddito imponibile come manutenzione immobiliare; può essere ammesso fino al 100% dei costi riconosciuti. Non è un sussidio diretto e il vantaggio federale vale presumibilmente solo fino a fine 2027." },
  ...
  // ─── SOLARANLAGE + WÄRMEPUMPE (DE) ───────────────────────────────────────
  {
    ...
    ctaText: 'Lassen Sie Solaranlage und Wärmepumpe gemeinsam auf den Energiebedarf Ihres Gebäudes abstimmen. PvPro.ch vermittelt kostenlos zertifizierte Installateure, die beide Systeme aus einer Hand planen und installieren.',
    ctaButton: 'Kostenlose Offerte anfordern',
    formUrl: '/anfrage',
  ...
  // ─── SOLARANLAGE + WÄRMEPUMPE (FR) ───────────────────────────────────────
  {
    ...
    ctaText: "Faites dimensionner ensemble l'installation solaire et la pompe à chaleur selon les besoins énergétiques du bâtiment. PvPro.ch vous met gratuitement en contact avec des installateurs certifiés qui planifient et installent les deux systèmes.",
  ...
  // ─── SOLARANLAGE + WÄRMEPUMPE (EN) ───────────────────────────────────────
  {
    ...
    ctaText: 'Have the solar system and heat pump sized together for the building’s energy needs. PvPro.ch connects you free of charge with certified installers who plan and install both systems.',
  ...
  // ─── SOLARANLAGE + WÄRMEPUMPE (IT) ───────────────────────────────────────
  {
    ...
    ctaText: "Fai dimensionare insieme impianto solare e pompa di calore in base al fabbisogno energetico dell'edificio. PvPro.ch ti mette gratuitamente in contatto con installatori certificati che pianificano e installano entrambi i sistemi.",
    ctaButton: 'Richiedi preventivo gratuito',
    formUrl: '/it/richiesta',
    relatedSlugs: ['lohnt-sich-solaranlage-schweiz-2026', 'solaranlage-steuerabzug-schweiz-2026', 'batteriespeicher-solaranlage-lohnt-sich'],
    relatedPageLinks: [
