...
export const cityContents: Record<string, CityContent> = {
  ...
  ticino: {
    ...
    heroDescription: "Confronta fino a 3 offerte per un impianto fotovoltaico in Ticino. Con oltre 2'100 ore di sole all'anno e incentivi federali e cantonali, ogni tetto è un potenziale generatore di energia pulita.",
    ...
    whySolarReasons: [
      {
        title: "Oltre 2'100 ore di sole – tra i più alti della Svizzera",
        description: "Il Ticino registra più ore di sole di qualsiasi altro cantone svizzero. Un'installazione da 5 kWp produce tipicamente 5'500–6'500 kWh/anno, a seconda dell'orientamento e dell'inclinazione del tetto.",
      },
      {
        title: "Incentivi federali e cantonali cumulabili",
        description: "La rimunerazione unica federale (Pronovo) può coprire fino al 30% dei costi di un impianto di riferimento. Ulteriori contributi cantonali e comunali possono essere disponibili a seconda della situazione specifica — è necessario verificarli individualmente.",
      },
      {
        title: "Autoconsumo: più importante che mai nel 2026",
        description: "La remunerazione per l'energia immessa in rete è variabile (le tariffe FER-CU per Q2 2026 partono da 4,6 ct./kWh). Aumentare l'autoconsumo con una batteria, una pompa di calore o un wallbox migliora significativamente il valore dell'energia prodotta.",
      },
    ],
    ...
    faqs: [
      ...
      { question: "Quanto costa un impianto fotovoltaico in Ticino?", answer: "I costi variano in base alle dimensioni, al tipo di tetto e alla configurazione. Indicativamente, un impianto da 5 kWp per una casa unifamiliare può costare tra CHF 9'000 e CHF 15'000 lordi prima degli incentivi. Richiedete più preventivi per confrontare i prezzi reali nella vostra situazione." },
      ...
      { question: "Conviene aggiungere una batteria?", answer: "Una batteria di accumulo aumenta l'autoconsumo dal 30% tipico fino al 60–70%, riducendo la dipendenza dalla rete. Non è però sempre finanziariamente vantaggiosa: dipende dal costo dell'accumulo, dalla tariffa elettrica e dall'uso energetico. Richiedete preventivi con e senza batteria per confrontare." },
