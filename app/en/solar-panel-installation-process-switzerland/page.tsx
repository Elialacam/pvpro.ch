    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Timeline</p>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <Link href="/en/get-solar-panel-quotes" className="text-[#fcb210] hover:underline font-medium">Compare free quotes</Link>{' '}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="rounded-3xl p-8" style={{ background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', border: '1px solid #e2e8f0' }}>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Your tasks</p>
