              ...
              {blogPostsI18n.en.map((post) => (
                <Link key={post.slug} href={post.href ?? `/en/blog/${post.slug}`}
                  ...
                  <div className="relative h-48 overflow-hidden bg-gray-100">
                    <Image src={post.image} alt={post.title} fill className="object-cover object-center group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 640px) 100vw, 50vw" />
          ...
          <div className="w-full lg:w-[320px] flex-shrink-0">
            <div className="lg:sticky lg:top-28 flex flex-col gap-6">
              ...
              <div className="rounded-2xl border border-gray-100 p-6 bg-white">
                <h3 className="text-sm font-bold text-gray-700 uppercase tracking-widest mb-4">Topics</h3>
