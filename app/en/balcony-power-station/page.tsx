      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="mb-16 max-w-3xl">
          ...
          <p className="text-gray-500 text-lg leading-relaxed">
            A balcony power station enables tenants and apartment owners to produce their own solar electricity — without a roof. Find out everything about costs, registration and rules in Switzerland.
          </p>
        </div>
