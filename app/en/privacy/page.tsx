    ...
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Collection and Processing of Personal Data</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">2.1 Contact Form</h3>
          <p className="text-gray-600 leading-relaxed mb-6">
