    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Why it pays off</p>
        ...
        <section>
          <div className="mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Services overview</p>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <tbody>
                  {costs.map((row, i) => (
                    <tr key={row.service} className={row.highlight ? 'bg-orange-50' : i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className={`px-5 py-3.5 text-right font-bold text-sm ${row.highlight ? 'text-[#fcb210]' : 'text-gray-900'}`}>{row.cost}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Maintenance intervals</p>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-5">How often should a solar system be maintained?</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-5">
              For a complete{' '}
              <Link href="/en/complete-solar-solution-switzerland" className="text-[#fcb210] hover:underline font-medium">all-in-one solution</Link>{' '}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="rounded-3xl p-8" style={{ background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', border: '1px solid #e2e8f0' }}>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">DIY work</p>
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-500 text-sm mt-5">
            ...
            Or all{' '}
            <Link href="/en/solar-comparison-portal-switzerland" className="text-[#fcb210] hover:underline font-medium">providers at a glance</Link>?
          </p>
        </section>
