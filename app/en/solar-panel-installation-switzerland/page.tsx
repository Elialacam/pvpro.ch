    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      {step.n === '2' ? (
                        <>
                          ...
                          <Link href="/bewilligungspflicht-solaranlage-schweiz" className="text-[#fcb210] hover:underline font-medium">permit-free</Link>.
                        </>
                      ) : step.n === '5' ? (
                        <>
                          ...
                          <Link href="/en/solar-subsidies" className="text-[#fcb210] hover:underline font-medium">one-time remuneration (OUR)</Link> with Pronovo.
                        </>
                      ) : step.text}
                    </p>
                  </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Scheduling</p>
