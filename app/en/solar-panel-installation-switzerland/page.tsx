...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pvpro.ch/en/solar-panel-installation-switzerland',
    languages: {
      'de-CH': 'https://pvpro.ch/solaranlage-installieren-schweiz',
      'fr-CH': 'https://pvpro.ch/fr/installer-panneau-solaire-suisse',
      'en': 'https://pvpro.ch/en/solar-panel-installation-switzerland',
      'it-CH': 'https://pvpro.ch/it/installare-impianto-solare-svizzera',
      'x-default': 'https://pvpro.ch/solaranlage-installieren-schweiz',
    },
  },
  openGraph: {
    ...
    url: 'https://pvpro.ch/en/solar-panel-installation-switzerland',
    type: 'website',
    locale: 'en_US',
    siteName: 'PVPro',
  },
