      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  {step.n === '1' ? (
                    <>
                      ...
                      <Link href="/en/solar-with-battery" className="text-[#fcb210] hover:underline font-medium">battery storage</Link>{' '}
                      or heat pump.
                    </>
                  ) : step.text}
                </p>
              ...
              {quoteContents.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm leading-relaxed">
                    {i === 6 ? (
                      <>Subsidy (<Link href="/en/solar-subsidies" className="text-[#fcb210] hover:underline font-medium">OUR</Link>) already deducted or shown separately</>
                    ) : item}
                  </span>
                </li>
              ))}
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Transparency</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">What does requesting quotes cost?</h2>
          </div>
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { icon: <Coins className="w-6 h-6 text-[#fcb210]" />, title: 'Free', text: "For homeowners, requesting quotes is completely free — no hidden fees." },
              { icon: <FileText className="w-6 h-6 text-[#fcb210]" />, title: 'No subscription', text: "No subscription and no obligation to place an order." },
              { icon: <Clock className="w-6 h-6 text-[#fcb210]" />, title: 'We are funded differently', text: "We receive a commission from the installer you select — not from you." },
            ].map(c => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {buildingTypes.map(b => (
              <Link key={b.title} href={b.href} className="group rounded-2xl p-8 text-center border border-gray-200 hover:border-orange-300 bg-white hover:shadow-md transition-all">
                ...
                <p className="text-[#fcb210] text-sm font-medium mt-3">Request a quote →</p>
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-600 mb-8 max-w-xl mx-auto leading-relaxed">
            ...
            <Link href="/en/quote" className="text-[#fcb210] hover:underline font-medium">certified installers</Link>{' '}
