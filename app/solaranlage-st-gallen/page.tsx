...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Solaranlage St. Gallen SG - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in St. Gallen: Vergleichen Sie kostenlos Offerten von geprüften Solarteuren.`,
  };
}
