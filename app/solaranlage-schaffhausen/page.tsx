...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Solaranlage Schaffhausen SH - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Schaffhausen: Vergleichen Sie kostenlos Offerten von geprüften Solarteuren.`,
  };
}
