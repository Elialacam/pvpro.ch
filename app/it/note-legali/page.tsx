    ...
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none">
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Informazioni ai sensi dell'art. 5 nLPD</h2>
          ...
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Numero di identificazione delle imprese (IDI)</h2>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            la correttezza, la completezza e l'attualità dei contenuti. In quanto fornitori di servizi, siamo
            responsabili dei nostri contenuti su queste pagine ai sensi delle leggi generali. Non siamo però tenuti
            a monitorare le informazioni trasmesse o memorizzate da terzi, né a ricercare circostanze che indichino
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            Non possiamo quindi assumerci alcuna responsabilità per tali contenuti esterni. Il rispettivo fornitore
            o gestore delle pagine collegate è sempre responsabile del loro contenuto.
          </p>
          ...
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Risoluzione delle controversie</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            La Commissione europea mette a disposizione una piattaforma per la risoluzione online delle controversie
            (ODR). Il nostro indirizzo e-mail è indicato nelle note legali sopra. Non siamo disposti né obbligati a
            partecipare a procedure di risoluzione delle controversie davanti a un organo di conciliazione per i consumatori.
          </p>
        </div>
      </div>
    </section>
