  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section>
          <div className="mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Funzionamento invernale</p>
          ...
          <div className="mt-6 bg-orange-50 border border-orange-200 rounded-xl p-5">
            <p className="text-orange-800 text-sm leading-relaxed">
              ...
              <Link href="/it/blog/solaranlage-winter-schweiz" className="text-[#fcb210] hover:underline font-medium">fotovoltaico in inverno</Link>{' '}
        ...
        <section>
          <div className="mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Scelta dei moduli</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
