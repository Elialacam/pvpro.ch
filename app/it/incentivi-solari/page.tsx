...
const tableRows = [
  { size: '5 kWp', totale: itRange(ECONOMIC_FACTS.systemCosts.bySize[5], 'CHF') },
  { size: '8 kWp', totale: itRange(ECONOMIC_FACTS.systemCosts.bySize[8], 'CHF'), highlight: true },
  { size: '10 kWp', totale: itRange(ECONOMIC_FACTS.systemCosts.bySize[10], 'CHF') },
];
    ...
    <main className="min-h-screen bg-white">
      <section className="relative pt-28 pb-20 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0d1117 0%, #1a2236 100%)' }}>
        <div className="absolute inset-0 opacity-20">
          <Image src="/images/hero-solar-panels.webp" alt="Pannelli solari sul tetto di una casa in Svizzera" fill sizes="100vw" className="object-cover" priority />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  { value: 'Individuale', unit: '', label: 'Calcolato da Pronovo' },
                  { value: itRange(ECONOMIC_FACTS.systemPaybackYears.plateau, 'anni'), unit: '', label: 'Ammortamento Altopiano' },
                  { value: itRange(ECONOMIC_FACTS.moduleLifetimeYears, 'anni'), unit: '', label: 'Durata moduli' },
                ].map(s => (
        ...
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solardaecher-quartier-see-schweiz.webp" alt="Quartiere residenziale con tetti solari su un lago svizzero" width={700} height={500} sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
              L’importo della RU dipende tra l’altro dalla data di messa in esercizio, dalla potenza, dal tipo di impianto e dagli eventuali bonus. Pronovo lo calcola individualmente.
              {' '}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="rounded-3xl overflow-hidden shadow-xl border border-gray-100">
               <div className="grid grid-cols-2 gap-0" style={{ background: 'linear-gradient(135deg, #1a2236, #0d1117)' }}>
                 {['Dimensione impianto', 'Costi lordi'].map(h => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/hero-family-solar.webp" alt="Casa unifamiliare con impianto solare" width={700} height={500} sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" className="w-full h-auto object-cover" />
            </div>
            <div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between rounded-2xl px-6 py-4 border border-gray-100">
                 ...
                 <div className="rounded-2xl px-6 py-4 border border-orange-100 bg-orange-50">
                   <p className="text-orange-700 font-medium">Importo RU</p>
                   <p className="text-sm text-gray-600 mt-1">Calcolato per l’impianto specifico da <a href="https://pronovo.ch/" target="_blank" rel="noreferrer" className="text-[#fcb210] hover:underline">Pronovo</a>.</p>
                 </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solaranlage-flachdach-gewerbe-rhein.webp" alt="Pannelli solari sul tetto piano di un edificio commerciale lungo il Reno" width={700} height={500} sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
