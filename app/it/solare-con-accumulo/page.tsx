    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solaranlage-tessin-villa-palmen.webp" alt="Costi impianto solare Svizzera" width={700} height={500} className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solaranlage-flachdach-basel-rhein.webp" alt="Produzione elettricità solare" width={700} height={500} className="w-full h-auto object-cover" />
            </div>
            <div>
