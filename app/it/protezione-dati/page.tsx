  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        <h1 className="text-4xl font-display font-medium tracking-normal text-gray-900 mb-8">Protezione dei dati</h1>
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl font-display font-medium tracking-normal text-gray-900 mt-8 mb-4">1. Titolare del trattamento</h2>
