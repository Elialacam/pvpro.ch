...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pvpro.ch/it/come-funziona' },
};
...
const steps = [
  {
    ...
    details: ['Nome, telefono ed e-mail', 'Indirizzo completo del tuo immobile', 'Nessun account o registrazione richiesta', '100% gratuito e senza impegno'],
  },
  {
    ...
    details: ['Fino a 3 preventivi indipendenti', 'Solo professionisti certificati', 'Installatori della tua regione', 'Offerte personalizzate per il tuo tetto'],
  },
  {
    ...
    details: ['Prezzi reali, nessuna offerta civetta', 'Nessun installatore ha la priorità', 'Nessun contratto con PVPro', 'Decisione libera, senza minimo'],
  },
];
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="rounded-2xl border border-gray-100 p-8 sm:p-10 mb-12">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <Link href="/it/faq" className="text-sm font-semibold text-[#F97316] hover:underline">Vedi tutte le FAQ →</Link>
          </div>
        </div>
        ...
        <div className="rounded-2xl p-10 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">Compila il modulo in meno di 2 minuti e ricevi fino a 3 preventivi da installatori certificati.</p>
