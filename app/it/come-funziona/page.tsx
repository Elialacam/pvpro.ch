    ...
    <main className="min-h-screen bg-white pt-28 pb-20">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="max-w-3xl mb-20">
          <p className="text-sm font-semibold text-[#fcb210] uppercase tracking-widest mb-3">Semplice e trasparente</p>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-[#fcb210] uppercase tracking-widest mb-3">Perché PVPro?</p>
        ...
        <div className="rounded-2xl border border-gray-100 p-8 sm:p-10 mb-12">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <Link href="/it/faq" className="text-sm font-semibold text-[#fcb210] hover:underline">
              Vedi tutte le FAQ →
            </Link>
          </div>
        </div>
