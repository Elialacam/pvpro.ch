      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-md">
            <img loading="lazy" src="/images/asset-panel-closeup-1.webp" alt="Pannelli solari Svizzera" className="w-full h-72 object-cover" />
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="rounded-2xl overflow-hidden shadow-md">
            <img loading="lazy" src="/images/asset-haus-luftbild-2.webp" alt="Casa unifamiliare con impianto solare" className="w-full h-72 object-cover" />
          </div>
          <div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-md">
            <img loading="lazy" src="/images/asset-beratung-indoor-1.webp" alt="Consulenza solare Svizzera" className="w-full h-72 object-cover" />
          </div>
        </section>
