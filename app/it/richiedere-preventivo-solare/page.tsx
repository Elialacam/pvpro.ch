      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  {step.n === '1' ? (
                    <>
                      ...
                      <Link href="/it/solare-con-batteria" className="text-[#fcb210] hover:underline font-medium">accumulo a batteria</Link>{' '}
                      o pompa di calore.
                    </>
                  ) : step.text}
                </p>
              ...
              {quoteContents.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm leading-relaxed">
                    {i === 6 ? (
                      <>Sussidio (<Link href="/it/incentivi-solari" className="text-[#fcb210] hover:underline font-medium">RU</Link>) già detratto o indicato separatamente</>
                    ) : item}
                  </span>
                </li>
              ))}
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Trasparenza</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Quanto costa richiedere preventivi?</h2>
          </div>
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { icon: <Coins className="w-6 h-6 text-[#fcb210]" />, title: 'Gratuito', text: "Per i proprietari, la richiesta di preventivi è completamente gratuita — nessun costo nascosto." },
              { icon: <FileText className="w-6 h-6 text-[#fcb210]" />, title: 'Nessun abbonamento', text: "Nessun abbonamento e nessun obbligo di ordinare." },
              { icon: <Clock className="w-6 h-6 text-[#fcb210]" />, title: 'Ci finanziamo diversamente', text: "Riceviamo una commissione dall'installatore selezionato — non da voi." },
            ].map(c => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {buildingTypes.map(b => (
              <Link key={b.title} href={b.href} className="group rounded-2xl p-8 text-center border border-gray-200 hover:border-orange-300 bg-white hover:shadow-md transition-all">
                ...
                <p className="text-[#fcb210] text-sm font-medium mt-3">Richiedere un preventivo →</p>
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-600 mb-8 max-w-xl mx-auto leading-relaxed">
            ...
            <Link href="/it/preventivo" className="text-[#fcb210] hover:underline font-medium">installatori certificati</Link>{' '}
