          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-12 h-12 bg-primary text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-display font-extrabold uppercase tracking-tight">
                  1
                </div>
                <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-2">Dachfläche eingeben</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-2">Verbrauch angeben</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-2">Ergebnis erhalten</h3>
                <p className="text-gray-600 text-sm">
