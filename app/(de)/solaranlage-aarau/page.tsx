...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('aarau');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'aarau'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'aarau'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'aarau'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'aarau'} currentCanton={city.canton} />
