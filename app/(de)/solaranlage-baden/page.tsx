...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('baden');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'baden'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'baden'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'baden'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'baden'} currentCanton={city.canton} />
