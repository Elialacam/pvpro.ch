    ...
    <section className="section-padding bg-gradient-to-b from-primary-50 to-white min-h-[80vh] flex items-center">
      <div className="container-custom max-w-3xl">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 sm:p-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-display font-extrabold uppercase tracking-tight text-gray-900 mb-4">
          ...
          <div className="text-left mb-12">
            <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mb-6 text-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-lg font-display font-extrabold uppercase tracking-tight text-primary">1</span>
                </div>
                <div>
                  <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-1">Wir prüfen Ihre Angaben</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-lg font-display font-extrabold uppercase tracking-tight text-primary">2</span>
                </div>
                <div>
                  <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-1">Wir kontaktieren lokale Installateure</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="text-lg font-display font-extrabold uppercase tracking-tight text-primary">3</span>
                </div>
                <div>
                  <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-1">Sie erhalten Ihre Offerten</h3>
                  <p className="text-gray-600">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <h3 className="font-display font-extrabold uppercase tracking-tight text-gray-900 mb-4">Fragen? Wir sind für Sie da</h3>
