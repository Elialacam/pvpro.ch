    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <img loading="lazy" src="/images/asset-installateur-dach-2.webp" alt="Solaranlage Installation Schweiz" className="w-full h-72 object-cover rounded-3xl object-top" />
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <img loading="lazy" src="/images/asset-beratung-indoor-2.webp" alt="Installateur wählen Schweiz" className="w-full h-72 object-cover rounded-3xl" />
