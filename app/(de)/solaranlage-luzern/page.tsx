...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('luzern');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'luzern'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'luzern'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'luzern'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'luzern'} currentCanton={city.canton} />
