...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'thun'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'thun'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'thun'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'thun'} currentCanton={city.canton} />
