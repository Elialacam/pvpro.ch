    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-28 pb-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0d1117 0%, #1a2236 100%)' }}>
        <div className="absolute inset-0 opacity-20">
          <Image src="/images/batteriespeicher-weiss-modern.png" alt="Solaranlage mit Speicher" fill className="object-cover" priority />
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solaranlage-tessin-villa-palmen.png" alt="Kosten Solaranlage Schweiz" width={700} height={500} className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/solaranlage-flachdach-basel-rhein.png" alt="Solarstrom Produktion" width={700} height={500} className="w-full h-auto object-cover" />
            </div>
            <div>
