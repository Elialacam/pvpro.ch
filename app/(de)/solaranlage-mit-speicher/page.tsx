        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="border-2 border-gray-200 rounded-2xl p-6">
              <h3 className="text-xl font-display font-medium tracking-normal text-gray-900 mb-4 flex items-center gap-2">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="text-2xl font-display font-medium tracking-normal text-gray-900">
                  CHF 9.500 - 25.000
                </div>
            ...
            <div className="border-2 border-primary rounded-2xl p-6 bg-primary-50">
              ...
              <div className="mt-6 pt-4 border-t border-primary/20">
                <div className="text-2xl font-display font-medium tracking-normal text-primary">
                  CHF 19.500 - 40.000
                </div>
            ...
            {storageOptions.map((option, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="text-2xl font-display font-medium tracking-normal text-gray-900">{option.capacity}</div>
                </div>
                <div className="text-xl font-display font-medium tracking-normal text-gray-900 mb-4">
                  CHF {option.price}
                </div>
