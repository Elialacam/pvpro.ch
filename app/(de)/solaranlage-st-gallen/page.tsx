...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('st-gallen');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'st-gallen'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'st-gallen'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'st-gallen'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'st-gallen'} currentCanton={city.canton} />
