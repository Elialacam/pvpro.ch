      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="rounded-3xl overflow-hidden">
            <Image src="/images/asset-installateur-dach-3.webp" alt="Techniker auf Dach mit Solarpanelen – Bewilligungspflicht Schweiz" width={1600} height={1600} sizes="(max-width: 1024px) 100vw, 640px" className="w-full h-72 object-cover rounded-3xl" />
