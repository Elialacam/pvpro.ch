...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('schaffhausen');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'schaffhausen'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'schaffhausen'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'schaffhausen'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'schaffhausen'} currentCanton={city.canton} />
