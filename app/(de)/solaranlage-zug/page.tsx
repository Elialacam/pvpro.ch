...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'zug'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'zug'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'zug'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'zug'} currentCanton={city.canton} />
