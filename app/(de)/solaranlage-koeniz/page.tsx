...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('koeniz');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'koeniz'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'koeniz'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'koeniz'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'koeniz'} currentCanton={city.canton} />
