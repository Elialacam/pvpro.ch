    ...
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none">
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Angaben gemäss Art. 5 DSG</h2>

          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <p className="text-gray-900 font-sans font-bold mb-4">PVPro</p>
          ...
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Mehrwertsteuer-Nummer</h2>
          ...
          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Konzeption und Design</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            PVPro<br />
            Zürich, Schweiz
          </p>

          <h2 className="text-2xl font-sans font-semibold tracking-normal text-gray-900 mt-8 mb-4">Technische Umsetzung</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
