  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom max-w-4xl">
        <h1 className="text-4xl font-display font-extrabold uppercase tracking-tight text-gray-900 mb-8">Impressum</h1>

        <div className="prose prose-gray max-w-none">
          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Angaben gemäss Art. 5 DSG</h2>
          ...
          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Vertretungsberechtigte Person</h2>
          <p className="text-gray-600 mb-6">Max Mustermann, Geschäftsführer</p>

          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Handelsregister</h2>
          <p className="text-gray-600 mb-6">
            Handelsregister-Nummer: CHE-123.456.789<br />
            Handelsregisteramt: Zürich
          </p>

          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Mehrwertsteuer-Nummer</h2>
          <p className="text-gray-600 mb-6">CHE-123.456.789 MWST</p>

          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Haftungsausschluss</h2>

          <h3 className="text-xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-6 mb-3">Haftung für Inhalte</h3>
          ...
          <h3 className="text-xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-6 mb-3">Haftung für Links</h3>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-6 mb-3">Urheberrecht</h3>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Streitbeilegung</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Konzeption und Design</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            PVPro<br />
            Zürich, Schweiz
          </p>

          <h2 className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900 mt-8 mb-4">Technische Umsetzung</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
