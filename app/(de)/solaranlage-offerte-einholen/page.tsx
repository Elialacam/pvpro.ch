    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Der entscheidende Vorteil</p>
        ...
        <section>
          <div className="text-center mb-12">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">In 3 Schritten</p>
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm leading-relaxed">
                    {item.includes('EIV') ? (
                      <>
                        {'Förderung ('}
                        <Link href="/foerderungen" className="text-[#fcb210] hover:underline font-medium">EIV</Link>
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Transparenz</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { icon: <Coins className="w-6 h-6 text-[#fcb210]" />, title: 'Kostenlos', text: 'Für Hausbesitzer ist das Einholen von Offerten vollständig kostenlos — keine versteckten Gebühren.' },
              { icon: <FileText className="w-6 h-6 text-[#fcb210]" />, title: 'Kein Abo', text: 'Keine Abo-Kosten und keine Verpflichtung zur Auftragserteilung.' },
              { icon: <Clock className="w-6 h-6 text-[#fcb210]" />, title: 'Wir finanzieren uns anders', text: 'Wir erhalten eine Vermittlungsgebühr vom beauftragten Installateur — nicht von Ihnen.' },
            ].map(c => (
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Alle Gebäudetypen</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {buildingTypes.map(b => (
              <Link key={b.title} href={b.href} className="group rounded-2xl p-8 text-center border border-gray-200 hover:border-orange-300 bg-white hover:shadow-md transition-all">
                <h3 className="font-bold text-gray-900 text-lg mb-2 group-hover:text-[#fcb210] transition-colors">{b.title}</h3>
                <p className="text-gray-500 text-sm">{b.desc}</p>
                <p className="text-[#fcb210] text-sm font-medium mt-3">Offerte einholen →</p>
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-600 mb-8 max-w-xl mx-auto leading-relaxed">
            ...
            <Link href="/anfrage" className="text-[#fcb210] hover:underline font-medium">zertifizierten Installateuren</Link>{' '}
