            ...
            {costData.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-display font-medium tracking-normal text-gray-900">{item.type}</h3>
                    <p className="text-gray-600">{item.size}</p>
                  </div>
                </div>
                <div className="text-3xl font-display font-medium tracking-normal text-gray-900 mb-2">
                  CHF {item.priceRange}
                </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-lg font-display font-medium tracking-normal text-gray-900 mb-2">Anlagengrösse</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-lg font-display font-medium tracking-normal text-gray-900 mb-2">Modulqualität</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-lg font-display font-medium tracking-normal text-gray-900 mb-2">Dachtyp</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-lg font-display font-medium tracking-normal text-gray-900 mb-2">Speicher</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-primary-50 rounded-2xl p-8 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div>
                  <div className="text-4xl font-display font-medium tracking-normal text-primary mb-2">30%</div>
                  <p className="text-gray-700">Einmalvergütung (EIV) vom Bund</p>
                </div>
                <div>
                  <div className="text-4xl font-display font-medium tracking-normal text-primary mb-2">+10-20%</div>
                  <p className="text-gray-700">Kantonale Förderungen (variiert)</p>
                </div>
                <div>
                  <div className="text-4xl font-display font-medium tracking-normal text-primary mb-2">100%</div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="font-display font-medium tracking-normal text-gray-900 mb-4 flex items-center gap-2">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-gray-300 pt-3 flex justify-between">
                  <span className="font-display font-medium tracking-normal text-gray-900">Effektive Kosten</span>
                  <span className="font-display font-medium tracking-normal text-xl text-primary">CHF 13.300</span>
                </div>
              </div>
            </div>
          </div>
