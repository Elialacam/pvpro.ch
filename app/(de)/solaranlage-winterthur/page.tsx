...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const city = getCityBySlug('winterthur');
  ...
  return {
    ...
    alternates: {
      canonical: `https://pvpro.ch/solaranlage-${'winterthur'}`,
    },
    openGraph: {
      ...
      url: `https://pvpro.ch/solaranlage-${'winterthur'}`,
      type: 'website',
      locale: 'de_CH',
      siteName: 'PVPro',
    },
...
export default function CityPage({ params }: PageProps) {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": `https://pvpro.ch/solaranlage-${'winterthur'}`
              }
            ]
          })
        }}
      ...
      <RelatedCities currentCitySlug={'winterthur'} currentCanton={city.canton} />
