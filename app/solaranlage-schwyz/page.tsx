    ...
    <>
      <section className="bg-gradient-to-br from-blue-50 to-primary-50 section-padding text-center">
        <div className="container-custom">
          <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6">Solaranlage Schwyz SZ</h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Vergleichen Sie kostenlos Angebote von geprüften Solarteuren im Kanton Schwyz.</p>
