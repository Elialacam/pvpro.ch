...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Solaranlage Zürich ZH - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Zürich: Vergleichen Sie gratuitamente Offerten von geprüften Solarteuren.`,
  };
}
