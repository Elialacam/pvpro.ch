      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-md">
            <img loading="lazy" src="/images/asset-installateur-dach-1.webp" alt="Installation solaire maison individuelle Suisse" className="w-full h-80 object-cover" />
          </div>
        </section>
        ...
        <section className="rounded-3xl bg-[#0f1f3d] p-8 sm:p-12 overflow-hidden relative">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <img loading="lazy" src="/images/asset-haus-luftbild-1.webp" alt="Maison individuelle avec installation solaire" className="w-full h-72 object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="rounded-2xl overflow-hidden shadow-md">
            <img loading="lazy" src="/images/asset-beratung-indoor-2.webp" alt="Conseil installation solaire" className="w-full h-80 object-cover" />
          </div>
          <div>
