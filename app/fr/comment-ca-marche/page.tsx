...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pvpro.ch/fr/comment-ca-marche' },
};
...
const steps = [
  {
    ...
    details: ['Nom, téléphone et e-mail', 'Adresse complète de votre bien', 'Aucun compte requis, aucune inscription', '100% gratuit et sans engagement'],
  },
  {
    ...
    details: ['Jusqu\'à 3 devis indépendants', 'Uniquement des professionnels certifiés', 'Installateurs de votre région', 'Offres adaptées à votre toiture'],
  },
  {
    number: '3', Icon: CheckCircle,
    title: 'Comparez et choisissez',
    subtitle: 'Sans pression, sans obligation',
    description: 'Vous recevez les offres des installateurs directement et comparez les prix, prestations et conditions tranquillement. Vous décidez librement si et quelle offre vous acceptez.',
    details: ['Vrais prix, sans offres d\'appel', 'Aucun installateur n\'a la priorité', 'Aucun contrat avec PVPro', 'Décision libre, sans minimum'],
  },
];
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="rounded-2xl border border-gray-100 p-8 sm:p-10 mb-12">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <Link href="/fr/faq" className="text-sm font-semibold text-[#F97316] hover:underline">Voir toutes les FAQ →</Link>
          </div>
        </div>
        ...
        <div className="rounded-2xl p-10 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">Remplissez le formulaire en moins de 2 minutes et recevez jusqu'à 3 devis d'installateurs certifiés.</p>
