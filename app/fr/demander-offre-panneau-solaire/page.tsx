    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">L&apos;avantage décisif</p>
        ...
        <section>
          <div className="text-center mb-12">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">En 3 étapes</p>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  {step.n === '1' ? (
                    <>
                      ...
                      <Link href="/fr/solaire-avec-batterie" className="text-[#fcb210] hover:underline font-medium">stockage par batterie</Link>{' '}
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm leading-relaxed">
                    {item.includes('RU') ? (
                      <>
                        {'Subvention ('}
                        <Link href="/fr/subventions-solaires" className="text-[#fcb210] hover:underline font-medium">RU</Link>
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Transparence</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { icon: <Coins className="w-6 h-6 text-[#fcb210]" />, title: 'Gratuit', text: 'Pour les propriétaires, la demande d\'offres est entièrement gratuite — aucun frais caché.' },
              { icon: <FileText className="w-6 h-6 text-[#fcb210]" />, title: 'Pas d\'abonnement', text: 'Aucun abonnement et aucune obligation de passer commande.' },
              { icon: <Clock className="w-6 h-6 text-[#fcb210]" />, title: 'Nous nous finançons autrement', text: 'Nous recevons une commission de l\'installateur mandaté — pas de vous.' },
            ].map(c => (
        ...
        <section>
          <div className="text-center mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Tous les types de bâtiments</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {buildingTypes.map(b => (
              <Link key={b.title} href={b.href} className="group rounded-2xl p-8 text-center border border-gray-200 hover:border-orange-300 bg-white hover:shadow-md transition-all">
                ...
                <p className="text-[#fcb210] text-sm font-medium mt-3">Demander une offre →</p>
              </Link>
            ))}
          </div>
        </section>
