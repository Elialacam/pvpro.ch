    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Niveau fédéral</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-5">
              Subvention fédérale : la{' '}
              <Link href="/fr/subventions-solaires" className="text-[#fcb210] hover:underline">Rétribution Unique (RU)</Link>
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              La principale subvention pour les installations solaires en Suisse est la{' '}
              <Link href="/fr/subventions-solaires" className="text-[#fcb210] hover:underline font-medium">Rétribution Unique (RU)</Link>{' '}
        ...
        <section>
          <div className="mb-10">
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Niveau cantonal</p>
              ...
              <div key={step.n} className="rounded-2xl p-7 text-center" style={{ background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', border: '1px solid #e2e8f0' }}>
                ...
                <p className="text-gray-600 text-xs leading-relaxed">
                  {step.link ? (
                    <>
                      Après l&apos;{' '}
                      <Link href="/fr/installer-panneau-solaire-suisse" className="text-[#fcb210] hover:underline font-medium">installation</Link>,
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-500 text-sm mt-5">
            ...
            Ou toutes les{' '}
            <Link href="/fr/subventions-solaires" className="text-[#fcb210] hover:underline font-medium">subventions suisses</Link>{' '}
            en aperçu ?
          </p>
        </section>
