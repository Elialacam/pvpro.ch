...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pvpro.ch/fr/photovoltaique-climat-suisse',
    languages: {
      'de-CH': 'https://pvpro.ch/photovoltaik-schweizer-klima',
      'fr-CH': 'https://pvpro.ch/fr/photovoltaique-climat-suisse',
      'en': 'https://pvpro.ch/en/solar-panels-swiss-climate',
      'it-CH': 'https://pvpro.ch/it/fotovoltaico-clima-svizzero',
      'x-default': 'https://pvpro.ch/photovoltaik-schweizer-klima',
    },
  },
  openGraph: {
    ...
    url: 'https://pvpro.ch/fr/photovoltaique-climat-suisse',
    type: 'website',
    locale: 'fr_CH',
    siteName: 'PVPro',
  },
