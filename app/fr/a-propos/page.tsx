...
const values = [
  ...
  },
  {
    icon: Star,
    title: 'Transparence',
    text: "Aucun frais caché, aucun engagement. Vous obtenez des prix réels d'installateurs réels dans votre canton.",
  },
];
    ...
    <main className="min-h-screen bg-white pt-28 pb-20">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <p className="text-sm font-semibold text-[#fcb210] uppercase tracking-widest mb-3">Notre histoire</p>
        ...
        <div className="mb-24">
          <div className="max-w-3xl mx-auto text-center mb-14">
            <p className="text-sm font-semibold text-[#fcb210] uppercase tracking-widest mb-3">Notre mission</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="order-1 lg:order-2">
            <p className="text-sm font-semibold text-[#fcb210] uppercase tracking-widest mb-3">Comment nous travaillons</p>
          ...
          <div className="flex flex-col gap-4 text-sm max-w-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">Via Rinaldo Simen 3<br />6900 Lugano, Suisse</p>
              </div>
            </div>
