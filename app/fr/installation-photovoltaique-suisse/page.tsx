    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16 py-16 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Calendrier</p>
            ...
            <p className="text-gray-600 leading-relaxed">
              Prêt à démarrer ?{' '}
              <Link href="/fr/demander-offre-panneau-solaire" className="text-[#fcb210] hover:underline font-medium">Comparez gratuitement des offres</Link>{' '}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="rounded-3xl p-8" style={{ background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', border: '1px solid #e2e8f0' }}>
            <p className="text-xs font-bold text-[#fcb210] uppercase tracking-widest mb-3">Vos tâches</p>
        ...
        <section className="rounded-3xl p-10 sm:p-14 text-center" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)' }}>
          ...
          <p className="text-gray-500 text-sm mt-5">
            D&apos;abord{' '}
            <Link href="/fr/demander-offre-panneau-solaire" className="text-[#fcb210] hover:underline font-medium">comparer les offres</Link>{' '}
            ou les{' '}
