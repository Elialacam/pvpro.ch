...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Solaranlage Basel BS/BL - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Basel: Vergleichen Sie gratuitamente Offerten von geprüften Solarteuren.`,
  };
}
