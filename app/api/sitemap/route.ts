...
${blogSlugs.filter(slug => slug !== 'lohnt-sich-solaranlage-schweiz-2026' && slug !== 'solaranlage-steuerabzug-schweiz-2026' && slug !== 'solaranlage-waermepumpe-kombinieren-schweiz' && slug !== 'besten-solarinstallateur-schweiz-finden' && slug !== 'batteriespeicher-brandgefahr-sicherheit-schweiz' && slug !== 'solaranlage-installateur-konkurs-garantie-schweiz').map((slug) => entry4(`/blog/${slug}`, `/fr/blog/${slug}`, `/en/blog/${slug}`, `/it/blog/${slug}`, 0.6)).join('')}
