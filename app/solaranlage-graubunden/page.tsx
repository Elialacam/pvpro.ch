...
const citySlug = 'graubunden';

export async function generateMetadata(): Promise<Metadata> {
  const city = getCityBySlug(citySlug);
  if (!city) return { title: 'Kanton nicht gefunden' };
  return {
    title: `Solaranlage Graubünden GR - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Graubünden: Vergleichen Sie kostenlos Offerten von geprüften Solarteuren.`,
  };
}
