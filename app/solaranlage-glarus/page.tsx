...
const citySlug = 'glarus';

export async function generateMetadata(): Promise<Metadata> {
  const city = getCityBySlug(citySlug);
  if (!city) return { title: 'Region nicht gefunden' };
  return {
    title: `Solaranlage Glarus GL - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Glarus: Vergleichen Sie kostenlos Offerten von geprüften Solarteuren.`,
  };
}
    ...
    <>
      <section className="bg-gradient-to-br from-blue-50 to-primary-50 section-padding text-center">
        <div className="container-custom">
          <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6">Solaranlage Glarus GL</h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Vergleichen Sie kostenlos Angebote von geprüften Solarteuren im Kanton Glarus.</p>
