...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Solaranlage Luzern LU - Kostenlose Offerten | PVPro`,
    description: `Solaranlage in Luzern: Vergleichen Sie kostenlos Offerten von geprüften Solarteuren. Sparen Sie fino a 30%.`,
  };
}
