              ...
              <div key={index} className="relative z-10">
                <div className="text-center">
                  ...
                  <div className="relative inline-block mb-6">
                    ...
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white font-display font-bold text-sm shadow-md z-30">
                      {item.step}
                    </div>
                  </div>
