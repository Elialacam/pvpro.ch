  ...
  return (
    <div style={{ position: 'fixed', bottom: '20px', right: '20px', zIndex: 99999, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '12px' }}>
        ...
        <div style={{ position: 'relative', background: 'white', borderRadius: '16px', boxShadow: '0 8px 30px rgba(0,0,0,0.15)', border: '1px solid #e5e7eb', padding: '16px', maxWidth: '250px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
            <span style={{ position: 'relative', width: '10px', height: '10px', display: 'inline-flex' }}>
              <span className="wa-online-ping" style={{ position: 'absolute', width: '100%', height: '100%', borderRadius: '50%', background: '#22c55e' }} />
              <span className="wa-online-dot" style={{ position: 'relative', width: '10px', height: '10px', borderRadius: '50%', background: '#22c55e', display: 'inline-block' }} />
            </span>
      ...
      <button
        ...
        className="wa-button-pulse"
        style={{ position: 'relative', width: '60px', height: '60px', background: '#25D366', border: 'none', borderRadius: '50%', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      >
        <span style={{ position: 'absolute', top: '-2px', right: '-2px', width: '14px', height: '14px', display: 'inline-flex' }}>
          <span className="wa-online-ping" style={{ position: 'absolute', width: '100%', height: '100%', borderRadius: '50%', background: '#4ade80' }} />
          <span className="wa-online-dot" style={{ position: 'relative', width: '14px', height: '14px', borderRadius: '50%', background: '#22c55e', display: 'inline-block', border: '2px solid white' }} />
        </span>
