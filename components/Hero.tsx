      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="lg:pt-8">
            <h1 className="text-4xl  sm:text-5xl  lg:text-5xl  font-sans font-semibold tracking-tight text-gray-900 mb-2 leading-tight">
              {content.title}
            </h1>
            <p className="text-2xl sm:text-3xl font-sans font-bold text-gray-800 mb-4">
              {content.subtitle}{' '}
