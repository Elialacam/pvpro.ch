    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div>
            <h3 className="text-white font-display font-medium tracking-tight mb-4">{content.contact.title}</h3>
          ...
          <div>
            <h3 className="text-white font-display font-medium tracking-tight mb-4">{content.followUs}</h3>
