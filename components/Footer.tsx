    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Lohnt sich Solaranlage 2026', href: '/blog/lohnt-sich-solaranlage-schweiz-2026' },
          { label: 'Solaranlage + Wärmepumpe', href: '/blog/solaranlage-waermepumpe-kombinieren-schweiz' },
          { label: 'Besten Installateur finden', href: '/blog/besten-solarinstallateur-schweiz-finden' },
          { label: 'Batteriespeicher — sicher?', href: '/blog/batteriespeicher-brandgefahr-sicherheit-schweiz' },
          { label: 'Installateur pleite — was nun?', href: '/blog/solaranlage-installateur-konkurs-garantie-schweiz' },
          { label: 'Solaranlage versichern', href: '/blog/solaranlage-versicherung-schweiz' },
          { label: 'Chinesisch vs. europäisch', href: '/blog/chinesische-vs-europaeische-solarmodule-schweiz' },
          { label: 'Solaranlage auf Norddach', href: '/blog/solaranlage-norddach-schweiz' },
          { label: 'FAQ',                         href: '/faq' },
        ],
      },
      {
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Rentabilité panneaux solaires 2026', href: '/fr/blog/rentabilite-panneau-solaire-suisse-2026' },
          { label: 'Solaire + pompe à chaleur', href: '/fr/blog/panneaux-solaires-pompe-chaleur-suisse' },
          { label: 'Trouver le meilleur installateur', href: '/fr/blog/trouver-meilleur-installateur-solaire-suisse' },
          { label: 'Batterie solaire — risques?',  href: '/fr/blog/batterie-solaire-danger-incendie-securite-suisse' },
          { label: 'Installateur en faillite?',   href: '/fr/blog/installateur-solaire-faillite-garantie-suisse' },
          { label: 'Assurance installation solaire', href: '/fr/blog/assurance-installation-solaire-suisse' },
          { label: 'Chinois vs. européens', href: '/fr/blog/panneaux-solaires-chinois-vs-europeens-suisse' },
          { label: 'Solaire sur toit nord', href: '/fr/blog/panneau-solaire-toit-nord-suisse' },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Is Solar Worth It 2026?',    href: '/en/blog/is-solar-worth-it-switzerland-2026' },
          { label: 'Solar + Heat Pump',          href: '/en/blog/solar-panels-heat-pump-combination-switzerland' },
          { label: 'Find the Best Installer',    href: '/en/blog/find-best-solar-installer-switzerland' },
          { label: 'Battery storage — safe?',   href: '/en/blog/solar-battery-fire-risk-safety-switzerland' },
          { label: 'Installer goes bankrupt?',  href: '/en/blog/solar-installer-bankruptcy-guarantee-switzerland' },
          { label: 'Solar panel insurance', href: '/en/blog/solar-panel-insurance-switzerland' },
          { label: 'Chinese vs. European panels', href: '/en/blog/chinese-vs-european-solar-panels-switzerland' },
          { label: 'Solar on north roof', href: '/en/blog/solar-panels-north-facing-roof-switzerland' },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: 'Vale la pena il solare 2026?', href: '/it/blog/vale-la-pena-impianto-solare-svizzera-2026' },
          { label: 'Solare + pompa di calore', href: '/it/blog/impianto-solare-pompa-calore-svizzera' },
          { label: 'Trovare il miglior installatore', href: '/it/blog/trovare-miglior-installatore-solare-svizzera' },
          { label: 'Accumulo — sicuro?',          href: '/it/blog/batteria-solare-rischio-incendio-sicurezza-svizzera' },
          { label: 'Installatore fallisce?',      href: '/it/blog/installatore-solare-fallimento-garanzia-svizzera' },
          { label: 'Assicurazione impianto solare', href: '/it/blog/assicurazione-impianto-solare-svizzera' },
          { label: 'Cinesi vs. europei', href: '/it/blog/pannelli-solari-cinesi-vs-europei-svizzera' },
          { label: 'Impianto su tetto nord', href: '/it/blog/impianto-solare-tetto-nord-svizzera' },
