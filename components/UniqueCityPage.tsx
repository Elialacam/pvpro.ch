    ...
    <>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6">
              ...
              <span className={`text-sm font-display font-bold ${theme.badge}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 max-w-3xl mx-auto">
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className={`text-3xl font-display font-bold ${theme.stats} mb-2`}>{city.sunshineHours || '1560'}</div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="text-3xl font-display font-bold text-green-600 mb-2">{content.pricing.roiYears}</div>
                <div className="text-sm text-gray-600">
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <div className="text-3xl font-display font-bold text-primary mb-2">45%</div>
                <div className="text-sm text-gray-600">
        ...
        <div className="container-custom max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 flex flex-col items-center text-center justify-center relative overflow-hidden group">
              ...
              <h3 className="text-3xl font-display font-bold text-gray-900 mb-4 relative">
              ...
              <div className="space-y-4 relative">
                ...
                <div className="inline-block bg-green-100 text-green-700 px-4 py-2 rounded-full font-display font-bold text-sm">
      ...
      <section className="relative section-padding bg-gray-900 overflow-hidden">
        ...
        <div className="container-custom max-w-4xl relative z-10">
          <div className="text-center text-white">
            <h2 className="text-3xl sm:text-4xl font-display font-bold mb-4 text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="text-4xl font-display font-bold text-white mb-2 drop-shadow-lg">{city.sunshineHours}</div>
                <div className="text-sm text-white/90 font-medium">
                  {city.language === 'it' ? 'Ore di sole' : 'Sonnenstunden'}
                </div>
              </div>
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="text-4xl font-display font-bold text-white mb-2 drop-shadow-lg">45%</div>
                <div className="text-sm text-white/90 font-medium">
                  {city.language === 'it' ? 'Sussidi' : 'Förderung'}
                </div>
              </div>
              <div className="group bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/30 hover:bg-white/20 hover:border-white/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="text-4xl font-display font-bold text-white mb-2 drop-shadow-lg">{content.pricing.roiYears}</div>
                <div className="text-sm text-white/90 font-medium">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl h-[500px]">
            ...
            <div className="absolute bottom-6 left-6 bg-white px-6 py-3 rounded-lg shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="font-display font-semibold text-gray-900 text-lg">{city.name}, {city.canton}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={`card bg-white shadow-lg`}>
            <div className="flex items-start gap-4">
              <div className={`w-16 h-16 bg-${accentColor}-600 rounded-full flex items-center justify-center flex-shrink-0`}>
                <span className="text-2xl font-display font-bold text-white">{content.testimonial.initials}</span>
              </div>
              <div>
                ...
                <div>
                  <div className="font-display font-bold text-gray-900">{content.testimonial.name}</div>
      ...
      <section className={`section-padding bg-gradient-to-r ${theme.cta} text-white`}>
        <div className="container-custom text-center">
          ...
          <a href="#formular" className={`bg-white ${theme.ctaButton} hover:bg-gray-100 font-display font-semibold py-4 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl inline-block`}>
