  ...
  return (
    <section className="section-padding bg-gray-50">
      <div className="container-custom max-w-6xl">
        <h2 className="text-2xl sm:text-3xl font-display font-medium tracking-tight text-gray-900 mb-8 text-center">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-display font-medium tracking-tight text-gray-900 group-hover:text-primary transition-colors mb-1">
                      {city.name}
                    </h3>
        ...
        <div className="text-center mt-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-primary hover:text-primary-600 font-display font-semibold transition-colors"
          >
