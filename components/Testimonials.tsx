    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-2xl font-display font-extrabold uppercase tracking-tight text-gray-900">{avgRating}</span>
          <div className="flex">
            {[...Array(5)].map((_, i) => (
              <Star
                key={i}
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-100 flex items-center justify-center">
                    {index === 0 ? (
                      ...
                      <img 
                        src="/images/testimonials/weber.png" 
                        alt={review.name}
                        className="w-full h-full object-cover"
                      />
                    ) : index === 5 ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-display font-semibold text-lg">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-1">
                      <span className="font-display font-semibold text-gray-900">{review.name}</span>
                      {review.verified && (
