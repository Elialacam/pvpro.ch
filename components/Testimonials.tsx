...
const reviewsByLocale: Record<string, Review[]> = {
  de: [
    { name: 'Thomas Weber',     avatar: '/images/testimonials/weber.png',  text: 'Wir sind sehr zufrieden mit unserer neuen Solaranlage. PVPro hat uns perfekt beraten und mit einem lokalen Fachbetrieb verbunden. Alles lief reibungslos!' },
    ...
    { name: 'Andreas Brunner',  avatar: '/images/testimonials/andreas.png', text: 'Der Prozess war so einfach! Formular ausgefüllt, drei Angebote erhalten, das beste gewählt. Jetzt produzieren wir unseren eigenen Strom.' },
    ...
    { name: 'Josef Berber',     avatar: '/images/testimonials/josef.png',  text: 'Installation sauber gemacht, die Monteure waren sehr freundlich. Anlage produziert echt ordentlich, sogar mehr als erwartet. Bin sehr zufrieden!' },
    ...
    { name: 'Tobias Schneider', avatar: '/images/testimonials/tobias.png', text: 'Kompetent, zuverlässig und professionell. Transparente Beratung mit exzellentem Service. Die Solaranlage hat sich schon nach 8 Jahren amortisiert.' },
    ...
    { name: 'Markus Frei',      avatar: '/images/testimonials/mtb.png',   text: 'Top Service, top Qualität. Die Monteure haben sehr sauber gearbeitet und alles verständlich erklärt. Kann ich nur weiterempfehlen!' },
    ...
    { name: 'Daniel Ochs',      avatar: '/images/testimonials/octo.png',  text: 'Ich bin total fasziniert von dem Service. Alles hat super geklappt, der Installateur war sehr professionell und die Anlage läuft einwandfrei.' },
  ...
  fr: [
    { name: 'Thomas Weber',     avatar: '/images/testimonials/weber.png',  text: 'Très satisfaits de notre nouvelle installation solaire. PVPro nous a parfaitement conseillés et mis en contact avec un professionnel local. Tout s\'est passé sans accroc !' },
    ...
    { name: 'Andreas Brunner',  avatar: '/images/testimonials/andreas.png', text: 'Le processus était si simple ! Formulaire rempli, trois offres reçues, la meilleure choisie. Maintenant nous produisons notre propre électricité.' },
    ...
    { name: 'Josef Berber',     avatar: '/images/testimonials/josef.png',  text: 'Installation soignée, les techniciens étaient très sympathiques. Le système produit vraiment bien, même plus que prévu. Je suis très satisfait !' },
    ...
    { name: 'Tobias Schneider', avatar: '/images/testimonials/tobias.png', text: 'Compétent, fiable et professionnel. Conseil transparent avec un service excellent. L\'installation solaire s\'est amortie en 8 ans.' },
    ...
    { name: 'Markus Frei',      avatar: '/images/testimonials/mtb.png',   text: 'Service de qualité, travail soigné. Les techniciens ont tout expliqué clairement. Je recommande sans hésitation !' },
    ...
    { name: 'Daniel Ochs',      avatar: '/images/testimonials/octo.png',  text: 'Je suis vraiment impressionné par le service. Tout s\'est déroulé parfaitement, l\'installateur était très professionnel.' },
  ...
  en: [
    { name: 'Thomas Weber',     avatar: '/images/testimonials/weber.png',  text: 'We are very happy with our new solar system. PVPro gave us perfect advice and connected us with a local expert. Everything went smoothly!' },
    ...
    { name: 'Andreas Brunner',  avatar: '/images/testimonials/andreas.png', text: 'The process was so easy! Filled in the form, received three quotes, chose the best. Now we produce our own electricity.' },
    ...
    { name: 'Josef Berber',     avatar: '/images/testimonials/josef.png',  text: 'Clean installation, the technicians were very friendly. The system produces really well, even more than expected. Very satisfied!' },
    ...
    { name: 'Tobias Schneider', avatar: '/images/testimonials/tobias.png', text: 'Competent, reliable and professional. Transparent advice with excellent service. The solar system paid for itself in 8 years.' },
    ...
    { name: 'Markus Frei',      avatar: '/images/testimonials/mtb.png',   text: 'Top service, top quality. The technicians worked cleanly and explained everything clearly. Highly recommend!' },
    ...
    { name: 'Daniel Ochs',      avatar: '/images/testimonials/octo.png',  text: 'I am totally impressed by the service. Everything went perfectly, the installer was very professional.' },
  ...
  it: [
    { name: 'Thomas Weber',     avatar: '/images/testimonials/weber.png',  text: 'Siamo molto soddisfatti del nostro nuovo impianto solare. PVPro ci ha consigliato perfettamente e ci ha messo in contatto con un professionista locale. Tutto è andato liscio!' },
    ...
    { name: 'Andreas Brunner',  avatar: '/images/testimonials/andreas.png', text: 'Il processo è stato semplicissimo! Modulo compilato, tre offerte ricevute, la migliore scelta. Ora produciamo la nostra elettricità.' },
    ...
    { name: 'Josef Berber',     avatar: '/images/testimonials/josef.png',  text: 'Installazione curata, i tecnici erano molto gentili. L\'impianto produce davvero bene, anche più del previsto. Sono molto soddisfatto!' },
    ...
    { name: 'Tobias Schneider', avatar: '/images/testimonials/tobias.png', text: 'Competente, affidabile e professionale. Consulenza trasparente con un servizio eccellente. L\'impianto solare si è ammortizzato in 8 anni.' },
    ...
    { name: 'Markus Frei',      avatar: '/images/testimonials/mtb.png',   text: 'Servizio di qualità, lavoro accurato. I tecnici hanno lavorato in modo impeccabile e spiegato tutto chiaramente. Solo da consigliare!' },
    ...
    { name: 'Daniel Ochs',      avatar: '/images/testimonials/octo.png',  text: 'Sono totalmente impressionato dal servizio. Tutto è andato alla perfezione, l\'installatore era molto professionale.' },
