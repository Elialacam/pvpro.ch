    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-sans font-semibold tracking-tight mb-4 text-gray-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
          {badges.map((badge, index) => (
            ...
            >
              ...
              <h3 className="font-sans font-semibold tracking-tight text-gray-900 text-lg mb-2">
                {badge.title}
              </h3>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            <div className="text-4xl font-sans font-semibold tracking-tight text-primary mb-2">100%</div>
