  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
          <div className="space-y-6">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center">
              {t.step1Title}
            </h3>
        <div className="flex gap-4 justify-center">
          ...
          >
            <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${
              formData.isOwner === 'yes' ? 'bg-green-100' : 'bg-green-50'
            }`}>
              <Check className="w-8 h-8 text-green-600" strokeWidth={3} />
            </div>
            <span className="font-sans font-semibold tracking-tight text-xl text-gray-900">{t.yes}</span>
          </button>
          <button
          ...
          >
            <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${
              formData.isOwner === 'no' ? 'bg-red-100' : 'bg-red-50'
            }`}>
              <X className="w-8 h-8 text-red-600" strokeWidth={3} />
            </div>
            <span className="font-sans font-semibold tracking-tight text-xl text-gray-900">{t.no}</span>
          </button>
        </div>
          </div>
        );
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <span className="font-sans font-semibold tracking-tight text-xs text-center whitespace-pre-line leading-tight text-gray-900">{option.label}</span>
              </button>
            );
          })}
        </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center px-2">
              {t.step3Title}
            </h3>
        <div className="flex gap-4 justify-center flex-wrap">
          {[
            ...
            return (
              ...
              >
                ...
                <span className="font-sans font-semibold tracking-tight text-gray-900 text-base">{option.label}</span>
              </button>
            );
          })}
        </div>
      ...
      case 4:
        return (
          <div className="space-y-4">
            <h3 className="text-xl sm:text-2xl font-sans font-semibold tracking-tight text-gray-900 text-center">
              {t.step4Title}
            </h3>
      ...
      case 5:
        return (
          <div className="space-y-4">
            <h3 className="text-xl sm:text-lg font-sans font-bold text-gray-900 text-center">
              {t.step5Title}
            </h3>
    ...
    return (
      <div id="formular" className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 relative">
        <div className="flex flex-col items-center justify-center py-8 space-y-8">
          <h2 className="text-2xl font-sans font-semibold tracking-tight text-gray-900">{t.loadingTitle}</h2>
