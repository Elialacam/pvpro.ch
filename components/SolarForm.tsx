...
export default function SolarForm() {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 2:
        return (
          <div className="space-y-8">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center leading-tight">{t.step2Title}</h3>
      ...
      case 3:
        return (
          <div className="space-y-8">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center leading-tight">{t.step3Title}</h3>
      ...
      case 4:
        return (
          <div className="space-y-8">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center leading-tight">{t.step4Title}</h3>
            <div className="w-full mx-auto">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
      ...
      case 5:
        return (
          <div className="space-y-6">
            <h3 className="text-xl sm:text-2xl font-sans font-bold text-gray-900 text-center leading-tight">{t.step5Title}</h3>
  ...
  return (
    <div id="formular" className="max-w-2xl mx-auto px-4 pt-8 pb-4 sm:pt-10 sm:px-10 sm:pb-6 bg-white rounded-3xl sm:rounded-[2rem] form-glow border-2 border-primary/20">
