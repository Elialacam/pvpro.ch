  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-display font-medium tracking-tight text-gray-900">Solarrechner</h2>
      </div>
      ...
      <div className="space-y-6 mb-8">
        <div>
          ...
          <div className="flex justify-between text-sm text-gray-600 mt-1">
            <span>20 m²</span>
            <span className="font-display font-medium tracking-tight text-primary">{roofSize} m²</span>
            <span>200 m²</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-between text-sm text-gray-600 mt-1">
            <span>1.000 kWh</span>
            <span className="font-display font-medium tracking-tight text-primary">{consumption.toLocaleString('de-CH')} kWh</span>
      ...
      {results && (
        <div className="border-t border-gray-200 pt-8">
          <h3 className="text-xl font-display font-medium tracking-tight text-gray-900 mb-6">Ihre Ergebnisse</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-primary-50 rounded-xl p-4">
              ...
              <div className="text-2xl font-display font-medium tracking-tight text-primary">{results.systemSize} kWp</div>
            </div>
            ...
            <div className="bg-trust-50 rounded-xl p-4">
              ...
              <div className="text-2xl font-display font-medium tracking-tight text-trust">{results.annualProduction.toLocaleString('de-CH')} kWh</div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-display font-medium tracking-tight text-gray-900">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-display font-medium tracking-tight text-primary">{results.savings.toLocaleString('de-CH')} CHF</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700">Amortisationszeit</span>
              <span className="font-display font-medium tracking-tight text-gray-900">ca. {results.paybackYears} Jahre</span>
            </div>
          </div>
