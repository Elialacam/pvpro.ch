...
export default function FAQ({ items, notes = true }: FAQProps) {
  ...
  return (
    <section className="section-padding bg-gray-50">
      <div className="container-custom max-w-4xl">
        ...
        {notes && <p className="mt-4 text-xs text-gray-500">{SYSTEM_PRICE_NOTES[locale] || SYSTEM_PRICE_NOTES.de}</p>}
        {notes && <p className="mt-2 text-xs text-gray-500">{SOURCE_NOTES[locale] || SOURCE_NOTES.de}</p>}
