...
export default function ThankYouConfirmation({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-white px-4 py-6 sm:px-6 sm:py-10">
      <div className="mx-auto w-full max-w-2xl">
        <div className="overflow-hidden rounded-3xl border border-orange-100 bg-white shadow-[0_24px_70px_-30px_rgba(31,41,55,0.35)]">
          <div className="px-5 pb-5 pt-7 text-center sm:px-10 sm:pb-7 sm:pt-9">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-orange-50 sm:h-16 sm:w-16">
          ...
          <div className="border-t border-gray-100 bg-gray-50/70 px-4 py-5 sm:px-8 sm:py-7">
