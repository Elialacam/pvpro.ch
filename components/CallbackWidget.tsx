                  ...
                  <div className="px-5 py-5 space-y-4" style={{ background: CREAM }}>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          placeholder="z.B. Max"
                          className={`w-full px-4 py-3 rounded-xl border-2 text-sm outline-none transition-colors bg-white ${errors.firstName ? 'border-red-300' : 'border-gray-200'}`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl border-2 text-sm outline-none transition-colors bg-white ${errors.lastName ? 'border-red-300' : 'border-gray-200'}`}
                          onFocus={e => (e.target.style.borderColor = GOLD)}
                          onBlur={e => (e.target.style.borderColor = errors.lastName ? '#fca5a5' : '#e5e7eb')}
